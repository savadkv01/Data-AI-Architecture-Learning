---
mode: agent
description: "Horizontal scaling through partitioning, rebalancing, and hot-spot avoidance."
---

# GitHub Copilot Prompt — Partitioning and Sharding

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-02 — Distributed Systems Deep Dive** - Chapter: **03** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Partitioning_and_Sharding.md`.
...
- Begin the file with a single top-level heading: `# Partitioning and Sharding`.
...
- Hot partitions and skew mitigation
- Secondary indexes across partitions

## 4. Prerequisites & Cross-References
Depends on Phase-02/[Replication and Consistency](02_Replication_and_Consistency.prompt.md).
...
- Return ONLY the complete Markdown content for `Partitioning_and_Sharding.md`.
