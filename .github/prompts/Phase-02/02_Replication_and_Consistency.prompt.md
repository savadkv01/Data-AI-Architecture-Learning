---
mode: agent
description: "Replication strategies and the full spectrum of consistency models."
---

# GitHub Copilot Prompt — Replication and Consistency

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-02 — Distributed Systems Deep Dive** - Chapter: **02** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Replication_and_Consistency.md`.
...
- Begin the file with a single top-level heading: `# Replication and Consistency`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Leader-follower, multi-leader, leaderless replication
- Sync vs async replication and durability
- Consistency models: linearizable, sequential, causal, eventual
- Read/write quorums and hinted handoff
- Conflict resolution and CRDTs

## 4. Prerequisites & Cross-References
Depends on Phase-02/[Consensus and Coordination](01_Consensus_and_Coordination.prompt.md).
...
- Return ONLY the complete Markdown content for `Replication_and_Consistency.md`.
