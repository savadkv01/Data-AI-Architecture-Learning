---
mode: agent
description: "2PC, sagas, and modern approaches to correctness across services."
---

# GitHub Copilot Prompt — Distributed Transactions

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-02 — Distributed Systems Deep Dive** - Chapter: **05** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Distributed_Transactions.md`.
...
- Begin the file with a single top-level heading: `# Distributed Transactions`.
...
- Spanner/TrueTime-style external consistency

## 4. Prerequisites & Cross-References
Depends on Phase-02/[CAP and PACELC](04_CAP_and_PACELC.prompt.md).
...
- Return ONLY the complete Markdown content for `Distributed_Transactions.md`.
