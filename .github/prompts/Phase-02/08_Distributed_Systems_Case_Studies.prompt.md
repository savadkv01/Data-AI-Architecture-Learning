---
mode: agent
description: "How Dynamo, Spanner, Kafka, and BigTable solved real distributed problems."
---

# GitHub Copilot Prompt — Distributed Systems Case Studies

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-02 — Distributed Systems Deep Dive** - Chapter: **08** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Distributed_Systems_Case_Studies.md`.
...
- Begin the file with a single top-level heading: `# Distributed Systems Case Studies`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Amazon Dynamo and DynamoDB
- Google Spanner and BigTable
- Apache Kafka replication and ISR
- Netflix and Uber resilience patterns
- Lessons and failure post-mortems

## 4. Prerequisites & Cross-References
Depends on all prior Phase-02 chapters.
...
- Return ONLY the complete Markdown content for `Distributed_Systems_Case_Studies.md`.
