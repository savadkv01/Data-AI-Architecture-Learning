---
mode: agent
description: "Reasoning about availability, consistency, and latency trade-offs correctly."
---

# GitHub Copilot Prompt — CAP and PACELC

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-02 — Distributed Systems Deep Dive** - Chapter: **04** - Estimated study time: **45 min + 2h**
...
- Produce **exactly ONE** standalone Markdown file named `CAP_and_PACELC.md`.
...
- Begin the file with a single top-level heading: `# CAP and PACELC`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- CAP theorem — what it does and does not say
- PACELC and the latency dimension
- Tunable consistency in practice
- Mapping real databases onto CAP/PACELC
...
- Return ONLY the complete Markdown content for `CAP_and_PACELC.md`.
