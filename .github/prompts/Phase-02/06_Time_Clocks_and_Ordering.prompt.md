---
mode: agent
description: "Logical clocks, vector clocks, and event ordering in distributed data."
---

# GitHub Copilot Prompt — Time, Clocks and Ordering

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-02 — Distributed Systems Deep Dive** - Chapter: **06** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Time_Clocks_and_Ordering.md`.
...
- Begin the file with a single top-level heading: `# Time, Clocks and Ordering`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Physical clocks, NTP, clock skew
- Lamport and vector clocks
- Happens-before and causality
- Hybrid logical clocks
- Event-time vs processing-time in streaming

## 4. Prerequisites & Cross-References
Depends on Phase-02/[Distributed Transactions](05_Distributed_Transactions.prompt.md).
...
- Return ONLY the complete Markdown content for `Time_Clocks_and_Ordering.md`.
