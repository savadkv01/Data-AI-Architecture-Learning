---
mode: agent
description: "VNets, private endpoints, and secure connectivity for data services."
---

# GitHub Copilot Prompt — Azure Networking

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-03 — Cloud & Azure Architecture** - Chapter: **04** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Azure_Networking.md`.
...
- Begin the file with a single top-level heading: `# Azure Networking`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- VNets, subnets, NSGs, UDRs
- Private Link and private endpoints for PaaS
- ExpressRoute, VPN, and hybrid connectivity
- Azure Firewall, DNS, and egress control
- Securing Databricks/Synapse/Storage networking

## 4. Prerequisites & Cross-References
Depends on Phase-03/[Azure Landing Zones](03_Azure_Landing_Zones.prompt.md) and Phase-00/[Networking Fundamentals](../Phase-00/04_Networking_Fundamentals.prompt.md).
...
- Return ONLY the complete Markdown content for `Azure_Networking.md`.
