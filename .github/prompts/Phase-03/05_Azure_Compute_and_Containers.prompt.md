---
mode: agent
description: "VMs, AKS, Container Apps, and Functions for data and AI workloads."
---

# GitHub Copilot Prompt — Azure Compute and Containers

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-03 — Cloud & Azure Architecture** - Chapter: **05** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Azure_Compute_and_Containers.md`.
...
- Begin the file with a single top-level heading: `# Azure Compute and Containers`.
...
- Serverless vs cluster compute trade-offs
...
- Return ONLY the complete Markdown content for `Azure_Compute_and_Containers.md`.
