---
mode: agent
description: "Reliability, security, cost, operations, and performance pillars applied to data."
---

# GitHub Copilot Prompt — Azure Well-Architected Framework

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-03 — Cloud & Azure Architecture** - Chapter: **07** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Well_Architected_Framework.md`.
...
- Begin the file with a single top-level heading: `# Azure Well-Architected Framework`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- The five WAF pillars for data platforms
- Reliability targets and RTO/RPO
- Security and identity baseline
- Cost optimization and FinOps hooks
- Operational excellence and reviews
...
- Return ONLY the complete Markdown content for `Well_Architected_Framework.md`.
