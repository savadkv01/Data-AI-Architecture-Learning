---
mode: agent
description: "ADLS Gen2, Blob, and storage tiers as the foundation of the lakehouse."
---

# GitHub Copilot Prompt — Azure Storage Services

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-03 — Cloud & Azure Architecture** - Chapter: **06** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Azure_Storage_Services.md`.
...
- Begin the file with a single top-level heading: `# Azure Storage Services`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Blob vs ADLS Gen2 hierarchical namespace
- Access tiers, lifecycle, and immutability
- Redundancy: LRS/ZRS/GRS/GZRS
- Performance, throughput, and throttling
- Security: SAS, RBAC, encryption, firewall

## 4. Prerequisites & Cross-References
Depends on Phase-00/[Storage Systems Fundamentals](../Phase-00/05_Storage_Systems_Fundamentals.prompt.md).
...
- Return ONLY the complete Markdown content for `Azure_Storage_Services.md`.
