---
mode: agent
description: "Cloud service models, shared responsibility, and cloud-native design principles."
---

# GitHub Copilot Prompt — Cloud Architecture Fundamentals

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-03 — Cloud & Azure Architecture** - Chapter: **01** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Cloud_Architecture_Fundamentals.md`.
...
- Begin the file with a single top-level heading: `# Cloud Architecture Fundamentals`.
...
Depends on Phase-02/[Distributed Systems Case Studies](../Phase-02/08_Distributed_Systems_Case_Studies.prompt.md).
...
- Return ONLY the complete Markdown content for `Cloud_Architecture_Fundamentals.md`.
