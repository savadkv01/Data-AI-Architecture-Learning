---
mode: agent
description: "When and how to span clouds and on-premises without accidental complexity."
---

# GitHub Copilot Prompt — Multi-Cloud and Hybrid Architecture

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-03 — Cloud & Azure Architecture** - Chapter: **08** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Multi_Cloud_and_Hybrid.md`.
...
- Begin the file with a single top-level heading: `# Multi-Cloud and Hybrid Architecture`.
...
- Portability vs deep native integration
- Reference multi-cloud data topologies

## 4. Prerequisites & Cross-References
Depends on Phase-03/[Azure Landing Zones](03_Azure_Landing_Zones.prompt.md).
...
- Return ONLY the complete Markdown content for `Multi_Cloud_and_Hybrid.md`.
