---
mode: agent
description: "Planning, prioritizing, and sequencing multi-year technical portfolios."
---

# GitHub Copilot Prompt — Roadmap and Portfolio Planning

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-19 — Leadership & Technical Strategy** - Chapter: **07** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Roadmap_and_Portfolio_Planning.md`.
...
- Begin the file with a single top-level heading: `# Roadmap and Portfolio Planning`.
...
- Measuring outcomes (OKRs)
- Communicating roadmaps

## 4. Prerequisites & Cross-References
Depends on Phase-01/[Technical Strategy and Roadmaps](../Phase-01/07_Technical_Strategy_and_Roadmaps.prompt.md).
...
- Return ONLY the complete Markdown content for `Roadmap_and_Portfolio_Planning.md`.
