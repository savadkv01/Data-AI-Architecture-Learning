---
mode: agent
description: "Writing design docs, ADRs, and strategy that scale decisions."
---

# GitHub Copilot Prompt — Technical Writing

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-19 — Leadership & Technical Strategy** - Chapter: **04** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Technical_Writing.md`.
...
- Begin the file with a single top-level heading: `# Technical Writing`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Design docs and one-pagers
...
Depends on Phase-01/[Architecture Decision Records](../Phase-01/03_Architecture_Decision_Records.prompt.md).
...
- Return ONLY the complete Markdown content for `Technical_Writing.md`.
