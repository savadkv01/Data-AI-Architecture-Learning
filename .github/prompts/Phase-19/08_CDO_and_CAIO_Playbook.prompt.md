---
mode: agent
description: "Operating model, org design, and strategy for data/AI executives."
---

# GitHub Copilot Prompt — CDO and CAIO Playbook

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-19 — Leadership & Technical Strategy** - Chapter: **08** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `CDO_and_CAIO_Playbook.md`.
...
- Begin the file with a single top-level heading: `# CDO and CAIO Playbook`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- CDO/CAIO mandate and scope
- Data/AI operating model and org design
- Value realization and ROI
- Risk, ethics, and governance at the top
- Building the data/AI strategy

## 4. Prerequisites & Cross-References
Depends on Phase-19/[Roadmap and Portfolio Planning](07_Roadmap_and_Portfolio_Planning.prompt.md) and Phase-01/[Technical Strategy and Roadmaps](../Phase-01/07_Technical_Strategy_and_Roadmaps.prompt.md).
...
- Return ONLY the complete Markdown content for `CDO_and_CAIO_Playbook.md`.
