---
mode: agent
description: "Aligning executives, product, and engineering around data/AI strategy."
---

# GitHub Copilot Prompt — Stakeholder Management

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-19 — Leadership & Technical Strategy** - Chapter: **03** - Estimated study time: **45 min + 2h**
...
- Produce **exactly ONE** standalone Markdown file named `Stakeholder_Management.md`.
...
- Begin the file with a single top-level heading: `# Stakeholder Management`.
...
- Return ONLY the complete Markdown content for `Stakeholder_Management.md`.
