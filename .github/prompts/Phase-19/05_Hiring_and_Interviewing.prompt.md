---
mode: agent
description: "Building and assessing high-performing data and AI teams."
---

# GitHub Copilot Prompt — Hiring and Interviewing

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-19 — Leadership & Technical Strategy** - Chapter: **05** - Estimated study time: **45 min + 2h**
...
- Produce **exactly ONE** standalone Markdown file named `Hiring_and_Interviewing.md`.
...
- Begin the file with a single top-level heading: `# Hiring and Interviewing`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Role and leveling calibration
- Structured interviews and rubrics
- System design and coding signals
- Bias reduction
- Building diverse teams

## 4. Prerequisites & Cross-References
Depends on Phase-19/[Technical Leadership](01_Technical_Leadership.prompt.md).
...
- Return ONLY the complete Markdown content for `Hiring_and_Interviewing.md`.
