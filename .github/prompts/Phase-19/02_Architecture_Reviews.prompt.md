---
mode: agent
description: "Running effective, constructive architecture and design reviews."
---

# GitHub Copilot Prompt — Architecture Reviews

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-19 — Leadership & Technical Strategy** - Chapter: **02** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Architecture_Reviews.md`.
...
- Begin the file with a single top-level heading: `# Architecture Reviews`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Review formats and cadence
...
- Return ONLY the complete Markdown content for `Architecture_Reviews.md`.
