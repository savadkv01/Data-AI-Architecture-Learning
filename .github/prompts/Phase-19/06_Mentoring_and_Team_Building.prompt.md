---
mode: agent
description: "Growing engineers and shaping healthy engineering culture."
---

# GitHub Copilot Prompt — Mentoring and Team Building

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-19 — Leadership & Technical Strategy** - Chapter: **06** - Estimated study time: **45 min + 2h**
...
- Produce **exactly ONE** standalone Markdown file named `Mentoring_and_Team_Building.md`.
...
- Begin the file with a single top-level heading: `# Mentoring and Team Building`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Mentoring and sponsorship
- Career ladders and growth
- Team topologies and Conway law
...
- Return ONLY the complete Markdown content for `Mentoring_and_Team_Building.md`.
