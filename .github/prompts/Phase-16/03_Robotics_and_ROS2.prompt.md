---
mode: agent
description: "Robotics data architecture, ROS2, and DDS communication."
---

# GitHub Copilot Prompt — Robotics and ROS2

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-16 — Domain-Specific & Frontier Data Platforms** - Chapter: **03** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Robotics_and_ROS2.md`.
...
- Begin the file with a single top-level heading: `# Robotics and ROS2`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- ROS2 nodes, topics, services, actions
- DDS and real-time communication
- Sensor fusion data pipelines
- Simulation and digital twins
- Fleet data collection and MLOps

## 4. Prerequisites & Cross-References
Depends on Phase-14/[Event-Driven Architecture](../Phase-14/01_Event_Driven_Architecture.prompt.md).
...
- Return ONLY the complete Markdown content for `Robotics_and_ROS2.md`.
