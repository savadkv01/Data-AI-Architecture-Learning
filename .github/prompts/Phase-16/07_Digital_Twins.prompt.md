---
mode: agent
description: "Modeling physical systems as live digital twins."
---

# GitHub Copilot Prompt — Digital Twins

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-16 — Domain-Specific & Frontier Data Platforms** - Chapter: **07** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Digital_Twins.md`.
...
- Begin the file with a single top-level heading: `# Digital Twins`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Digital twin definition language (DTDL)
- Azure Digital Twins
- Real-time state and simulation
- Twin graphs and relationships
- Use cases across industries

## 4. Prerequisites & Cross-References
Depends on Phase-16/[Industrial IoT](02_Industrial_IoT.prompt.md).
...
- Return ONLY the complete Markdown content for `Digital_Twins.md`.
