---
mode: agent
description: "Raster/vector geospatial data and large-scale EO processing."
---

# GitHub Copilot Prompt — Earth Observation and Geospatial Analytics

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-16 — Domain-Specific & Frontier Data Platforms** - Chapter: **06** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Earth_Observation_and_Geospatial.md`.
...
- Begin the file with a single top-level heading: `# Earth Observation and Geospatial Analytics`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Raster vs vector, COG, STAC
- Geospatial indexing (H3, S2, geohash)
- Planetary Computer and EO pipelines
- Spatial SQL and processing engines
- Geospatial ML

## 4. Prerequisites & Cross-References
Depends on Phase-16/[Space Data Platforms](05_Space_Data_Platforms.prompt.md).
...
- Return ONLY the complete Markdown content for `Earth_Observation_and_Geospatial.md`.
