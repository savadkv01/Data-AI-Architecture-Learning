---
mode: agent
description: "Satellite telemetry, downlink, and space-ground data architecture."
---

# GitHub Copilot Prompt — Space Data Platforms

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-16 — Domain-Specific & Frontier Data Platforms** - Chapter: **05** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Space_Data_Platforms.md`.
...
- Begin the file with a single top-level heading: `# Space Data Platforms`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Satellite telemetry and downlink
- Ground station as a service (Azure Orbital)
- Onboard vs ground processing
- Data prioritization over constrained links
- Mission data archives

## 4. Prerequisites & Cross-References
Depends on Phase-16/[IoT Data Platforms](01_IoT_Data_Platforms.prompt.md).
...
- Return ONLY the complete Markdown content for `Space_Data_Platforms.md`.
