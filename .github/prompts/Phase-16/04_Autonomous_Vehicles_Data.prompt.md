---
mode: agent
description: "Petabyte-scale sensor data pipelines for autonomy."
---

# GitHub Copilot Prompt — Autonomous Vehicles Data

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-16 — Domain-Specific & Frontier Data Platforms** - Chapter: **04** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Autonomous_Vehicles_Data.md`.
...
- Begin the file with a single top-level heading: `# Autonomous Vehicles Data`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Sensor suites: LiDAR, camera, radar
- Data ingestion and labeling at scale
- Scenario mining and replay
- Simulation and validation
- Storage and cost at PB scale

## 4. Prerequisites & Cross-References
Depends on Phase-16/[Robotics and ROS2](03_Robotics_and_ROS2.prompt.md).
...
- Return ONLY the complete Markdown content for `Autonomous_Vehicles_Data.md`.
