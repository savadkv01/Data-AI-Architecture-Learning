---
mode: agent
description: "OT/IT convergence, OPC UA, and industrial data platforms."
---

# GitHub Copilot Prompt — Industrial IoT (IIoT)

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-16 — Domain-Specific & Frontier Data Platforms** - Chapter: **02** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Industrial_IoT.md`.
...
- Begin the file with a single top-level heading: `# Industrial IoT (IIoT)`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- OT/IT convergence and Purdue model
...
- Return ONLY the complete Markdown content for `Industrial_IoT.md`.
