---
mode: agent
description: "Ingesting and processing device telemetry at massive scale."
---

# GitHub Copilot Prompt — IoT Data Platforms

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-16 — Domain-Specific & Frontier Data Platforms** - Chapter: **01** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `IoT_Data_Platforms.md`.
...
- Begin the file with a single top-level heading: `# IoT Data Platforms`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Device connectivity and protocols (MQTT/AMQP)
...
Depends on Phase-07/[Streaming Fundamentals](../Phase-07/01_Streaming_Fundamentals.prompt.md).
...
- Return ONLY the complete Markdown content for `IoT_Data_Platforms.md`.
