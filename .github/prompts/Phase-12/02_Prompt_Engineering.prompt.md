---
mode: agent
description: "Systematic prompt design, patterns, and structured outputs."
---

# GitHub Copilot Prompt — Prompt Engineering

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-12 — LLMOps & Agentic AI** - Chapter: **02** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Prompt_Engineering.md`.
...
- Begin the file with a single top-level heading: `# Prompt Engineering`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Zero/few-shot and chain-of-thought
...
Depends on Phase-12/[LLM Foundations](01_LLM_Foundations.prompt.md).
...
- Return ONLY the complete Markdown content for `Prompt_Engineering.md`.
