---
mode: agent
description: "Standardizing tool and context integration for agents with MCP."
---

# GitHub Copilot Prompt — Model Context Protocol (MCP)

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-12 — LLMOps & Agentic AI** - Chapter: **06** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Model_Context_Protocol_MCP.md`.
...
- Begin the file with a single top-level heading: `# Model Context Protocol (MCP)`.
...
- MCP vs proprietary plugin ecosystems

## 4. Prerequisites & Cross-References
Depends on Phase-12/[Agentic AI Architecture](05_Agentic_AI_Architecture.prompt.md).
...
- Return ONLY the complete Markdown content for `Model_Context_Protocol_MCP.md`.
