---
mode: agent
description: "Operating LLM applications: evaluation, cost, caching, and observability."
---

# GitHub Copilot Prompt — LLMOps

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-12 — LLMOps & Agentic AI** - Chapter: **04** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `LLMOps.md`.
...
- Begin the file with a single top-level heading: `# LLMOps`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- LLM lifecycle and versioning
- Prompt/response logging and tracing
- Cost controls, caching, routing
- Evaluation and regression testing
- Guardrails and safety in production

## 4. Prerequisites & Cross-References
Depends on Phase-12/[Retrieval Augmented Generation](03_Retrieval_Augmented_Generation.prompt.md) and Phase-11/[MLOps and MLflow](../Phase-11/03_MLOps_and_MLflow.prompt.md).
...
- Return ONLY the complete Markdown content for `LLMOps.md`.
