---
mode: agent
description: "Enterprise LLM platform: deployments, grounding, and governance on Azure."
---

# GitHub Copilot Prompt — Azure OpenAI and AI Foundry

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-12 — LLMOps & Agentic AI** - Chapter: **07** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Azure_OpenAI_and_AI_Foundry.md`.
...
- Begin the file with a single top-level heading: `# Azure OpenAI and AI Foundry`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Azure OpenAI deployments and quotas
- AI Foundry, agents, and prompt flow
- On Your Data and grounding
- Content safety and guardrails
- Networking, identity, and cost

## 4. Prerequisites & Cross-References
Depends on Phase-12/[LLMOps](04_LLMOps.prompt.md).
...
- Return ONLY the complete Markdown content for `Azure_OpenAI_and_AI_Foundry.md`.
