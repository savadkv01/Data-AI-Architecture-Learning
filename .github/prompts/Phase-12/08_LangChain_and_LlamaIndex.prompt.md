---
mode: agent
description: "Orchestration frameworks for LLM and agent applications."
---

# GitHub Copilot Prompt — LangChain and LlamaIndex

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-12 — LLMOps & Agentic AI** - Chapter: **08** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `LangChain_and_LlamaIndex.md`.
...
- Begin the file with a single top-level heading: `# LangChain and LlamaIndex`.
...
Depends on Phase-12/[Retrieval Augmented Generation](03_Retrieval_Augmented_Generation.prompt.md).
...
- Return ONLY the complete Markdown content for `LangChain_and_LlamaIndex.md`.
