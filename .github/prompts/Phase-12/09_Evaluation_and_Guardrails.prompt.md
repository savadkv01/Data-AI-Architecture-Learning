---
mode: agent
description: "Measuring and constraining LLM/agent quality and safety."
---

# GitHub Copilot Prompt — Evaluation and Guardrails

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-12 — LLMOps & Agentic AI** - Chapter: **09** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Evaluation_and_Guardrails.md`.
...
- Begin the file with a single top-level heading: `# Evaluation and Guardrails`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Offline and online evaluation
- LLM-as-judge and human eval
- Groundedness, relevance, safety metrics
...
- Return ONLY the complete Markdown content for `Evaluation_and_Guardrails.md`.
