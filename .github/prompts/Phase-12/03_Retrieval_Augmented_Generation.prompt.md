---
mode: agent
description: "Grounding LLMs with retrieval, chunking, and hybrid search."
---

# GitHub Copilot Prompt — Retrieval Augmented Generation

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-12 — LLMOps & Agentic AI** - Chapter: **03** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Retrieval_Augmented_Generation.md`.
...
- Begin the file with a single top-level heading: `# Retrieval Augmented Generation`.
...
Depends on Phase-12/[Prompt Engineering](02_Prompt_Engineering.prompt.md).
...
- Return ONLY the complete Markdown content for `Retrieval_Augmented_Generation.md`.
