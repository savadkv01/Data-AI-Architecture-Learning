---
mode: agent
description: "End-to-end warehouse architecture, MPP internals, and workload management."
---

# GitHub Copilot Prompt — Data Warehouse Architecture

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-06 — Data Modeling & Warehousing** - Chapter: **07** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Warehouse_Architecture.md`.
...
- Begin the file with a single top-level heading: `# Data Warehouse Architecture`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- MPP distribution and shuffle
- Synapse/Snowflake/BigQuery internals
- Workload isolation and concurrency
- Materialized views and result caching
- Warehouse vs lakehouse convergence

## 4. Prerequisites & Cross-References
Depends on Phase-06/[Dimensional Modeling](01_Dimensional_Modeling.prompt.md) and Phase-06/[Data Vault](02_Data_Vault.prompt.md).
...
- Return ONLY the complete Markdown content for `Data_Warehouse_Architecture.md`.
