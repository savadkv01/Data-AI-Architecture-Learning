---
mode: agent
description: "Hubs, links, and satellites for auditable, scalable enterprise modeling."
---

# GitHub Copilot Prompt — Data Vault 2.0

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-06 — Data Modeling & Warehousing** - Chapter: **02** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Vault.md`.
...
- Begin the file with a single top-level heading: `# Data Vault 2.0`.
...
- Loading patterns and parallelism
- When Data Vault fits vs Kimball
...
- Return ONLY the complete Markdown content for `Data_Vault.md`.
