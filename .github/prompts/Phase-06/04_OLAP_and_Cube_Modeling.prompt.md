---
mode: agent
description: "Aggregations, cubes, and tabular models for interactive analytics."
---

# GitHub Copilot Prompt — OLAP and Cube Modeling

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-06 — Data Modeling & Warehousing** - Chapter: **04** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `OLAP_and_Cubes.md`.
...
- Begin the file with a single top-level heading: `# OLAP and Cube Modeling`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- MOLAP/ROLAP/HOLAP
- Tabular models and VertiPaq
- Aggregations and pre-computation
- Power BI datasets and DAX basics
- Direct Lake vs import vs DirectQuery

## 4. Prerequisites & Cross-References
Depends on Phase-06/[Dimensional Modeling](01_Dimensional_Modeling.prompt.md).
...
- Return ONLY the complete Markdown content for `OLAP_and_Cubes.md`.
