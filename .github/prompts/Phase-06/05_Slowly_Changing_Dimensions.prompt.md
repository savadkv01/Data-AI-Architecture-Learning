---
mode: agent
description: "Tracking history correctly with SCD types 0 through 6."
---

# GitHub Copilot Prompt — Slowly Changing Dimensions

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-06 — Data Modeling & Warehousing** - Chapter: **05** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Slowly_Changing_Dimensions.md`.
...
- Begin the file with a single top-level heading: `# Slowly Changing Dimensions`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- SCD types 0-6
- Effective dating and surrogate keys
- MERGE-based SCD implementation
- Late-arriving dimensions
- SCD with Delta/Iceberg
...
- Return ONLY the complete Markdown content for `Slowly_Changing_Dimensions.md`.
