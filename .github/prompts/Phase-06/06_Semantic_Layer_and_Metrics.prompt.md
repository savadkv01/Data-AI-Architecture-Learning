---
mode: agent
description: "Centralized metrics definitions and the modern semantic layer."
---

# GitHub Copilot Prompt — Semantic Layer and Metrics

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-06 — Data Modeling & Warehousing** - Chapter: **06** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Semantic_Layer_and_Metrics.md`.
...
- Begin the file with a single top-level heading: `# Semantic Layer and Metrics`.
...
Depends on Phase-06/[OLAP and Cubes](04_OLAP_and_Cubes.prompt.md).
...
- Return ONLY the complete Markdown content for `Semantic_Layer_and_Metrics.md`.
