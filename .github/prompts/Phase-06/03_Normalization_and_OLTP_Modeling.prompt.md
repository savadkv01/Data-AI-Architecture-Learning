---
mode: agent
description: "Relational design, normal forms, and transactional workload modeling."
---

# GitHub Copilot Prompt — Normalization and OLTP Modeling

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-06 — Data Modeling & Warehousing** - Chapter: **03** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Normalization_and_OLTP.md`.
...
- Begin the file with a single top-level heading: `# Normalization and OLTP Modeling`.
...
- Return ONLY the complete Markdown content for `Normalization_and_OLTP.md`.
