---
mode: agent
description: "Kimball star schemas, facts, and dimensions for analytics."
---

# GitHub Copilot Prompt — Dimensional Modeling

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-06 — Data Modeling & Warehousing** - Chapter: **01** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Dimensional_Modeling.md`.
...
- Begin the file with a single top-level heading: `# Dimensional Modeling`.
...
- Return ONLY the complete Markdown content for `Dimensional_Modeling.md`.
