---
mode: agent
description: "SQL Server and Azure SQL engine internals, T-SQL, indexing, and performance."
---

# GitHub Copilot Prompt — SQL Server and Azure SQL

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-06 — Data Modeling & Warehousing** - Chapter: **08** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `SQL_Server_and_Azure_SQL.md`.
...
- Begin the file with a single top-level heading: `# SQL Server and Azure SQL`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Storage engine internals: pages, buffer pool, transaction log
- Query optimizer, execution plans, and cardinality estimation
- Indexing strategy: clustered, nonclustered, columnstore
- Concurrency, isolation levels, and deadlock analysis
- Azure SQL deployment models: Hyperscale, Managed Instance, HA/DR

## 4. Prerequisites & Cross-References
Depends on Phase-06/[Normalization and OLTP Modeling](03_Normalization_and_OLTP_Modeling.prompt.md) and Phase-06/[Data Warehouse Architecture](07_Data_Warehouse_Architecture.prompt.md).
...
- Return ONLY the complete Markdown content for `SQL_Server_and_Azure_SQL.md`.
