---
mode: agent
description: "A curated catalog of enterprise data and AI reference architectures."
---

# GitHub Copilot Prompt — Reference Architectures Catalog

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / Architecture** - Chapter: **01** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `Reference_Architectures.md`.
...
- Begin the file with a single top-level heading: `# Reference Architectures Catalog`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Lakehouse, streaming, and AI reference architectures
- Azure-first blueprints with OSS alternatives
- When to use each pattern
- Cost and reliability profiles
- Diagrams for each architecture

## 4. Prerequisites & Cross-References
Depends on Phase-05 and Phase-12.
...
- Return ONLY the complete Markdown content for `Reference_Architectures.md`.
