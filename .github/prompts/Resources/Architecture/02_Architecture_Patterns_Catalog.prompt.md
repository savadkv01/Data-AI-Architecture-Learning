---
mode: agent
description: "A reusable catalog of data and integration architecture patterns."
---

# GitHub Copilot Prompt — Architecture Patterns Catalog

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / Architecture** - Chapter: **02** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `Architecture_Patterns_Catalog.md`.
...
- Begin the file with a single top-level heading: `# Architecture Patterns Catalog`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Ingestion, storage, processing, serving patterns
...
- Return ONLY the complete Markdown content for `Architecture_Patterns_Catalog.md`.
