---
mode: agent
description: "A set of realistic data/AI system design scenarios with guidance."
---

# GitHub Copilot Prompt — System Design Scenarios

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / Interview** - Chapter: **02** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `System_Design_Scenarios.md`.
...
- Begin the file with a single top-level heading: `# System Design Scenarios`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- End-to-end scenario prompts
- Requirements and constraints
- Reference solutions and trade-offs
- Evaluation rubric
...
- Return ONLY the complete Markdown content for `System_Design_Scenarios.md`.
