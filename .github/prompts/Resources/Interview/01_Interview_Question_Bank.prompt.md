---
mode: agent
description: "A structured bank of interview questions across all handbook topics and levels."
---

# GitHub Copilot Prompt — Interview Question Bank

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / Interview** - Chapter: **01** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `Interview_Question_Bank.md`.
...
- Begin the file with a single top-level heading: `# Interview Question Bank`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Questions by topic and by level
- Engineer, staff, architect, CTO tiers
...
- Return ONLY the complete Markdown content for `Interview_Question_Bank.md`.
