---
mode: agent
description: "Build a production-style RAG application on Azure with evaluation."
---

# GitHub Copilot Prompt — RAG Lab

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / Labs** - Chapter: **04** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `RAG_Lab.md`.
...
- Begin the file with a single top-level heading: `# RAG Lab`.
...
- Return ONLY the complete Markdown content for `RAG_Lab.md`.
