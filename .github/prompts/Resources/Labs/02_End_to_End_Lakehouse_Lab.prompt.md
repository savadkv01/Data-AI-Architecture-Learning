---
mode: agent
description: "Build a full bronze-silver-gold lakehouse on Azure Databricks."
---

# GitHub Copilot Prompt — End-to-End Lakehouse Lab

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / Labs** - Chapter: **02** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `End_to_End_Lakehouse_Lab.md`.
...
- Begin the file with a single top-level heading: `# End-to-End Lakehouse Lab`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Ingestion to Delta bronze
- Silver cleansing and quality
- Gold marts and serving
...
- Return ONLY the complete Markdown content for `End_to_End_Lakehouse_Lab.md`.
