---
mode: agent
description: "Set up a reproducible local and Azure lab environment for the handbook."
---

# GitHub Copilot Prompt — Lab Environment Setup

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / Labs** - Chapter: **01** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `Lab_Environment_Setup.md`.
...
- Begin the file with a single top-level heading: `# Lab Environment Setup`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Local toolchain (Docker, Python, CLIs)
- Azure sandbox subscription and guardrails
...
- Return ONLY the complete Markdown content for `Lab_Environment_Setup.md`.
