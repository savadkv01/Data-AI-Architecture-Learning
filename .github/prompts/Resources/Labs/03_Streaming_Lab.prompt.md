---
mode: agent
description: "Build a real-time pipeline with Event Hubs/Kafka and stream processing."
---

# GitHub Copilot Prompt — Streaming Lab

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / Labs** - Chapter: **03** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `Streaming_Lab.md`.
...
- Begin the file with a single top-level heading: `# Streaming Lab`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Producer and ingestion setup
- Stream processing job
- Exactly-once sink to Delta
- Real-time dashboard
- Failure injection
...
- Return ONLY the complete Markdown content for `Streaming_Lab.md`.
