---
mode: agent
description: "A comprehensive glossary of data and AI architecture terminology."
---

# GitHub Copilot Prompt — Glossary

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / References** - Chapter: **01** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `Glossary.md`.
...
- Begin the file with a single top-level heading: `# Glossary`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Alphabetical term definitions
- Acronym expansions
- Cross-links to relevant chapters
- Azure/OSS/AWS/GCP equivalents
...
- Return ONLY the complete Markdown content for `Glossary.md`.
