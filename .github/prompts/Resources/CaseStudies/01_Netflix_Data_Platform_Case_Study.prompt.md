---
mode: agent
description: "How Netflix built its large-scale data platform and streaming analytics."
---

# GitHub Copilot Prompt — Netflix Data Platform Case Study

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / CaseStudies** - Chapter: **01** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `Netflix_Data_Platform.md`.
...
- Begin the file with a single top-level heading: `# Netflix Data Platform Case Study`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Netflix data platform evolution
- Keystone, Iceberg, and streaming
- Self-service and scale
- Failure stories and lessons
- What to reuse vs avoid

## 4. Prerequisites & Cross-References
Depends on Phase-05 and Phase-07.
...
- Return ONLY the complete Markdown content for `Netflix_Data_Platform.md`.
