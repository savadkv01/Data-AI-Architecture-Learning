---
mode: agent
description: "How LinkedIn created Kafka and the log-centric architecture."
---

# GitHub Copilot Prompt — LinkedIn and the Birth of Kafka

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / CaseStudies** - Chapter: **05** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `LinkedIn_Kafka_Story.md`.
...
- Begin the file with a single top-level heading: `# LinkedIn and the Birth of Kafka`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- The integration problem at LinkedIn
- The log as unifying abstraction
- Kafka and stream processing evolution
...
- Return ONLY the complete Markdown content for `LinkedIn_Kafka_Story.md`.
