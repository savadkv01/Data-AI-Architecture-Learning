---
mode: agent
description: "Spotify data platform, Backstage, and golden paths."
---

# GitHub Copilot Prompt — Spotify Data Platform Case Study

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / CaseStudies** - Chapter: **04** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `Spotify_Data_Platform.md`.
...
- Begin the file with a single top-level heading: `# Spotify Data Platform Case Study`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Spotify data ecosystem
- Backstage and platform engineering
- Event delivery at scale
- Autonomy and paved roads
...
- Return ONLY the complete Markdown content for `Spotify_Data_Platform.md`.
