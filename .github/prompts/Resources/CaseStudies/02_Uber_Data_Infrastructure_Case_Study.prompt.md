---
mode: agent
description: "Uber data infrastructure: Hudi, Michelangelo, and real-time systems."
---

# GitHub Copilot Prompt — Uber Data Infrastructure Case Study

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / CaseStudies** - Chapter: **02** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `Uber_Data_Infrastructure.md`.
...
- Begin the file with a single top-level heading: `# Uber Data Infrastructure Case Study`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Uber big-data stack and Hudi origins
- Michelangelo ML platform
- Real-time and geospatial systems
- Scale and cost lessons
- Applicable patterns

## 4. Prerequisites & Cross-References
Depends on Phase-04, Phase-07, and Phase-11.
...
- Return ONLY the complete Markdown content for `Uber_Data_Infrastructure.md`.
