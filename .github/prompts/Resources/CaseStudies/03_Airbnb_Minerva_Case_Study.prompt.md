---
mode: agent
description: "Airbnb metrics platform (Minerva) and the semantic layer story."
---

# GitHub Copilot Prompt — Airbnb Minerva Case Study

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Resources — Resources / CaseStudies** - Chapter: **03** - Estimated study time: **45-60 min + optional lab**
...
- Produce **exactly ONE** standalone Markdown file named `Airbnb_Minerva.md`.
...
- Begin the file with a single top-level heading: `# Airbnb Minerva Case Study`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Metric consistency problem
- Minerva architecture
- Semantic layer and governance
- Adoption and impact
- Lessons for metric platforms
...
- Return ONLY the complete Markdown content for `Airbnb_Minerva.md`.
