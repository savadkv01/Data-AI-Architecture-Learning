---
mode: agent
description: "Bronze/silver/gold layering for reliable, incremental data refinement."
---

# GitHub Copilot Prompt — Medallion Architecture

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-05 — Modern Data Engineering & Lakehouse** - Chapter: **03** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Medallion_Architecture.md`.
...
- Begin the file with a single top-level heading: `# Medallion Architecture`.
...
- Return ONLY the complete Markdown content for `Medallion_Architecture.md`.
