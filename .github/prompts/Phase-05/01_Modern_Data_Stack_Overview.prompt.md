---
mode: agent
description: "The components and topology of the modern data stack, end to end."
---

# GitHub Copilot Prompt — Modern Data Stack Overview

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-05 — Modern Data Engineering & Lakehouse** - Chapter: **01** - Estimated study time: **45 min + 2h**
...
- Produce **exactly ONE** standalone Markdown file named `Modern_Data_Stack_Overview.md`.
...
- Begin the file with a single top-level heading: `# Modern Data Stack Overview`.
...
- Open vs managed component choices
- Reference topology diagram

## 4. Prerequisites & Cross-References
Depends on Phase-04/[Table Format Comparison](../Phase-04/07_Table_Format_Comparison.prompt.md).
...
- Return ONLY the complete Markdown content for `Modern_Data_Stack_Overview.md`.
