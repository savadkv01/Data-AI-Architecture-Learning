---
mode: agent
description: "Orchestration and analytics with ADF pipelines and Synapse Analytics."
---

# GitHub Copilot Prompt — Azure Data Factory and Synapse

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-05 — Modern Data Engineering & Lakehouse** - Chapter: **06** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Azure_Data_Factory_and_Synapse.md`.
...
- Begin the file with a single top-level heading: `# Azure Data Factory and Synapse`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- ADF pipelines, datasets, integration runtimes
- Mapping data flows vs Spark
- Synapse dedicated vs serverless SQL
- Linked services and secure connectivity
- When to use ADF vs Databricks vs Fabric

## 4. Prerequisites & Cross-References
Depends on Phase-05/[Medallion Architecture](03_Medallion_Architecture.prompt.md).
...
- Return ONLY the complete Markdown content for `Azure_Data_Factory_and_Synapse.md`.
