---
mode: agent
description: "Designing reliable, idempotent, backfillable batch data pipelines."
---

# GitHub Copilot Prompt — Batch Pipeline Design

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-05 — Modern Data Engineering & Lakehouse** - Chapter: **09** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Batch_Pipeline_Design.md`.
...
- Begin the file with a single top-level heading: `# Batch Pipeline Design`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Idempotency and exactly-once semantics
- Backfills and reprocessing
- Partitioning and incremental watermarks
- SLAs, retries, and alerting
- Cost-aware scheduling

## 4. Prerequisites & Cross-References
Depends on Phase-05/[Azure Data Factory and Synapse](06_Azure_Data_Factory_and_Synapse.prompt.md).
...
- Return ONLY the complete Markdown content for `Batch_Pipeline_Design.md`.
