---
mode: agent
description: "Software-engineering discipline for SQL transformations with dbt."
---

# GitHub Copilot Prompt — dbt and Analytics Engineering

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-05 — Modern Data Engineering & Lakehouse** - Chapter: **08** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `dbt_and_Transformation.md`.
...
- Begin the file with a single top-level heading: `# dbt and Analytics Engineering`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Models, refs, sources, and DAGs
- Tests, snapshots, and documentation
- Incremental models and materializations
- dbt with Databricks/Synapse/Fabric
...
- Return ONLY the complete Markdown content for `dbt_and_Transformation.md`.
