---
mode: agent
description: "Azure Databricks architecture: clusters, jobs, Unity Catalog, and DLT."
---

# GitHub Copilot Prompt — Databricks Platform

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-05 — Modern Data Engineering & Lakehouse** - Chapter: **05** - Estimated study time: **75 min + 6h**
...
- Produce **exactly ONE** standalone Markdown file named `Databricks_Platform.md`.
...
- Begin the file with a single top-level heading: `# Databricks Platform`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Workspace, control plane, and data plane
- Cluster types, pools, and Photon
- Unity Catalog governance model
- Delta Live Tables and Workflows
- Security and networking on Azure

## 4. Prerequisites & Cross-References
Depends on Phase-05/[Apache Spark Internals](04_Apache_Spark_Internals.prompt.md).
...
- Return ONLY the complete Markdown content for `Databricks_Platform.md`.
