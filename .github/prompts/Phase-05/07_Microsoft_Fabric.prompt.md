---
mode: agent
description: "OneLake, Direct Lake, and the unified SaaS analytics platform."
---

# GitHub Copilot Prompt — Microsoft Fabric

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-05 — Modern Data Engineering & Lakehouse** - Chapter: **07** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Microsoft_Fabric.md`.
...
- Begin the file with a single top-level heading: `# Microsoft Fabric`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- OneLake and shortcuts
- Fabric workloads: Data Engineering, Warehouse, Real-Time
- Direct Lake mode for Power BI
- Capacity model and governance
- Fabric vs Databricks vs Synapse positioning

## 4. Prerequisites & Cross-References
Depends on Phase-05/[Lakehouse Architecture](02_Lakehouse_Architecture.prompt.md).
...
- Return ONLY the complete Markdown content for `Microsoft_Fabric.md`.
