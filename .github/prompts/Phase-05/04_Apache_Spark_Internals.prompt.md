---
mode: agent
description: "Catalyst, Tungsten, shuffle, and tuning for large-scale Spark workloads."
---

# GitHub Copilot Prompt — Apache Spark Internals

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-05 — Modern Data Engineering & Lakehouse** - Chapter: **04** - Estimated study time: **90 min + 6h**
...
- Produce **exactly ONE** standalone Markdown file named `Apache_Spark_Internals.md`.
...
- Begin the file with a single top-level heading: `# Apache Spark Internals`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Driver/executor model and DAG scheduling
- Catalyst optimizer and AQE
- Tungsten, codegen, and memory management
- Shuffle, skew, and spill
- Photon and performance tuning

## 4. Prerequisites & Cross-References
Depends on Phase-00/[Concurrency and Parallelism](../Phase-00/06_Concurrency_and_Parallelism.prompt.md).
...
- Return ONLY the complete Markdown content for `Apache_Spark_Internals.md`.
