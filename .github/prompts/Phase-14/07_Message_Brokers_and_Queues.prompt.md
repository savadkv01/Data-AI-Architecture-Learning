---
mode: agent
description: "Choosing and operating queues, logs, and brokers."
---

# GitHub Copilot Prompt — Message Brokers and Queues

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-14 — Event-Driven Architecture & Integration** - Chapter: **07** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Message_Brokers_and_Queues.md`.
...
- Begin the file with a single top-level heading: `# Message Brokers and Queues`.
...
- RabbitMQ, Kafka, Service Bus, SQS
...
- Return ONLY the complete Markdown content for `Message_Brokers_and_Queues.md`.
