---
mode: agent
description: "Events, brokers, and choreography for loosely coupled systems."
---

# GitHub Copilot Prompt — Event-Driven Architecture

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-14 — Event-Driven Architecture & Integration** - Chapter: **01** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Event_Driven_Architecture.md`.
...
- Return ONLY the complete Markdown content for `Event_Driven_Architecture.md`.
