---
mode: agent
description: "Service boundaries, communication, and data ownership for microservices."
---

# GitHub Copilot Prompt — Microservices Architecture

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-14 — Event-Driven Architecture & Integration** - Chapter: **02** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Microservices_Architecture.md`.
...
- Begin the file with a single top-level heading: `# Microservices Architecture`.
...
Depends on Phase-01/[Domain Driven Design](../Phase-01/05_Domain_Driven_Design.prompt.md).
...
- Return ONLY the complete Markdown content for `Microservices_Architecture.md`.
