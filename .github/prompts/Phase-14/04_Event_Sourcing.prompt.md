---
mode: agent
description: "Persisting state as an immutable event log with replay and audit."
---

# GitHub Copilot Prompt — Event Sourcing

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-14 — Event-Driven Architecture & Integration** - Chapter: **04** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Event_Sourcing.md`.
...
- Begin the file with a single top-level heading: `# Event Sourcing`.
...
- Auditability and temporal queries

## 4. Prerequisites & Cross-References
Depends on Phase-14/[CQRS](03_CQRS.prompt.md).
...
- Return ONLY the complete Markdown content for `Event_Sourcing.md`.
