---
mode: agent
description: "Separating read and write models for scalability and clarity."
---

# GitHub Copilot Prompt — CQRS

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-14 — Event-Driven Architecture & Integration** - Chapter: **03** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `CQRS.md`.
...
- Begin the file with a single top-level heading: `# CQRS`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Command vs query models
- Read model projections
- Consistency and eventual sync
- CQRS with event sourcing
- When CQRS adds vs removes complexity

## 4. Prerequisites & Cross-References
Depends on Phase-14/[Microservices Architecture](02_Microservices_Architecture.prompt.md).
...
- Return ONLY the complete Markdown content for `CQRS.md`.
