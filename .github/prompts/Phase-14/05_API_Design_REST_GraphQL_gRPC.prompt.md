---
mode: agent
description: "Designing robust, versioned APIs for data and services."
---

# GitHub Copilot Prompt — API Design: REST, GraphQL, gRPC

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-14 — Event-Driven Architecture & Integration** - Chapter: **05** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `API_Design.md`.
...
- Begin the file with a single top-level heading: `# API Design: REST, GraphQL, gRPC`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- REST maturity and resource design
...
- Return ONLY the complete Markdown content for `API_Design.md`.
