---
mode: agent
description: "Classic integration patterns for connecting heterogeneous systems."
---

# GitHub Copilot Prompt — Enterprise Integration Patterns

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-14 — Event-Driven Architecture & Integration** - Chapter: **06** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Enterprise_Integration_Patterns.md`.
...
- Begin the file with a single top-level heading: `# Enterprise Integration Patterns`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Messaging channels and routers
- Transformation and enrichment
- Aggregator, splitter, and saga
- iPaaS and Azure Logic Apps
- Anti-corruption layers

## 4. Prerequisites & Cross-References
Depends on Phase-14/[Event-Driven Architecture](01_Event_Driven_Architecture.prompt.md).
...
- Return ONLY the complete Markdown content for `Enterprise_Integration_Patterns.md`.
