---
mode: agent
description: "Iceberg table format, hidden partitioning, and open catalog interoperability."
---

# GitHub Copilot Prompt — Apache Iceberg

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-04 — Storage Systems & Table Formats** - Chapter: **05** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Apache_Iceberg.md`.
...
- Begin the file with a single top-level heading: `# Apache Iceberg`.
...
- REST catalog and engine interoperability
- Iceberg on Azure and OSS engines
...
- Return ONLY the complete Markdown content for `Apache_Iceberg.md`.
