---
mode: agent
description: "Row vs columnar formats and how they shape analytical performance."
---

# GitHub Copilot Prompt — File Formats: Parquet, ORC, Avro

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-04 — Storage Systems & Table Formats** - Chapter: **01** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `File_Formats.md`.
...
- Begin the file with a single top-level heading: `# File Formats: Parquet, ORC, Avro`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Row vs columnar layout
- Parquet internals: row groups, pages, encodings
- ORC and Avro use cases
...
- Return ONLY the complete Markdown content for `File_Formats.md`.
