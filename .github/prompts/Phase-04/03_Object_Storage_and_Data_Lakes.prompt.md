---
mode: agent
description: "Building reliable data lakes on object storage and avoiding the data swamp."
---

# GitHub Copilot Prompt — Object Storage and Data Lakes

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-04 — Storage Systems & Table Formats** - Chapter: **03** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Object_Storage_and_Data_Lakes.md`.
...
- Begin the file with a single top-level heading: `# Object Storage and Data Lakes`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Object storage consistency and listing costs
- Partitioning and small-file problems
- Data lake zones and layout conventions
- Metadata and manifest strategies
- MinIO as an S3-compatible OSS lake

## 4. Prerequisites & Cross-References
Depends on Phase-03/[Azure Storage Services](../Phase-03/06_Azure_Storage_Services.prompt.md).
...
- Return ONLY the complete Markdown content for `Object_Storage_and_Data_Lakes.md`.
