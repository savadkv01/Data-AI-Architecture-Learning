---
mode: agent
description: "Copy-on-write vs merge-on-read and incremental processing with Hudi."
---

# GitHub Copilot Prompt — Apache Hudi

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-04 — Storage Systems & Table Formats** - Chapter: **06** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Apache_Hudi.md`.
...
- Begin the file with a single top-level heading: `# Apache Hudi`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- COW vs MOR table types
- Record-level upserts and indexes
- Incremental queries and timeline
- Compaction and clustering
- When Hudi beats Delta/Iceberg

## 4. Prerequisites & Cross-References
Depends on Phase-04/[Delta Lake](04_Delta_Lake.prompt.md).
...
- Return ONLY the complete Markdown content for `Apache_Hudi.md`.
