---
mode: agent
description: "ACID transactions, time travel, and performance on the lakehouse with Delta."
---

# GitHub Copilot Prompt — Delta Lake

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-04 — Storage Systems & Table Formats** - Chapter: **04** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Delta_Lake.md`.
...
- Begin the file with a single top-level heading: `# Delta Lake`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Delta transaction log and protocol
- ACID, time travel, and MERGE
- OPTIMIZE, Z-ORDER, liquid clustering
- Deletion vectors and change data feed
- Delta on Azure Databricks and Fabric

## 4. Prerequisites & Cross-References
Depends on Phase-04/[Object Storage and Data Lakes](03_Object_Storage_and_Data_Lakes.prompt.md).
...
- Return ONLY the complete Markdown content for `Delta_Lake.md`.
