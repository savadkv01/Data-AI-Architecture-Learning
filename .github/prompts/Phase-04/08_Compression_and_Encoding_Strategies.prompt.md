---
mode: agent
description: "Tuning storage footprint and scan performance through encoding choices."
---

# GitHub Copilot Prompt — Compression and Encoding Strategies

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-04 — Storage Systems & Table Formats** - Chapter: **08** - Estimated study time: **45 min + 2h**
...
- Produce **exactly ONE** standalone Markdown file named `Compression_and_Encoding.md`.
...
- Begin the file with a single top-level heading: `# Compression and Encoding Strategies`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Codec trade-offs: ratio vs CPU
- Sorting and clustering for compressibility
- Column-level encoding tuning
- Impact on network and cache
- Benchmarking methodology

## 4. Prerequisites & Cross-References
Depends on Phase-04/[Columnar Storage Internals](02_Columnar_Storage_Internals.prompt.md).
...
- Return ONLY the complete Markdown content for `Compression_and_Encoding.md`.
