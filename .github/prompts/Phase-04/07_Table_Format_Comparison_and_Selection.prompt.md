---
mode: agent
description: "A decision framework for choosing Delta vs Iceberg vs Hudi in the enterprise."
---

# GitHub Copilot Prompt — Table Format Comparison and Selection

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-04 — Storage Systems & Table Formats** - Chapter: **07** - Estimated study time: **45 min + 2h**
...
- Produce **exactly ONE** standalone Markdown file named `Table_Format_Comparison.md`.
...
- Begin the file with a single top-level heading: `# Table Format Comparison and Selection`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Feature-by-feature comparison matrix
- Ecosystem and engine support
- Interoperability (XTable/UniForm)
- Vendor lock-in considerations
- Selection criteria by workload

## 4. Prerequisites & Cross-References
Depends on Phase-04/[Delta Lake](04_Delta_Lake.prompt.md), [Apache Iceberg](05_Apache_Iceberg.prompt.md), and [Apache Hudi](06_Apache_Hudi.prompt.md).
...
- Return ONLY the complete Markdown content for `Table_Format_Comparison.md`.
