---
mode: agent
description: "Encoding, compression, and vectorized execution over columnar data."
---

# GitHub Copilot Prompt — Columnar Storage Internals

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-04 — Storage Systems & Table Formats** - Chapter: **02** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Columnar_Storage_Internals.md`.
...
- Begin the file with a single top-level heading: `# Columnar Storage Internals`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Dictionary, RLE, delta, bit-packing encodings
...
Depends on Phase-04/[File Formats](01_File_Formats.prompt.md).
...
- Return ONLY the complete Markdown content for `Columnar_Storage_Internals.md`.
