---
mode: agent
description: "Kubernetes architecture and running data/AI workloads on AKS."
---

# GitHub Copilot Prompt — Kubernetes

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-09 — DataOps, Platform Engineering & DevOps** - Chapter: **06** - Estimated study time: **90 min + 6h**
...
- Produce **exactly ONE** standalone Markdown file named `Kubernetes.md`.
...
- Begin the file with a single top-level heading: `# Kubernetes`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Control plane and node components
- Pods, deployments, services, ingress
- StatefulSets, storage, and operators
- Autoscaling (HPA/VPA/cluster/KEDA)
- Spark/Kafka/ML operators on AKS

## 4. Prerequisites & Cross-References
Depends on Phase-09/[Containers Docker](05_Containers_Docker.prompt.md).
...
- Return ONLY the complete Markdown content for `Kubernetes.md`.
