---
mode: agent
description: "Declarative infrastructure with Terraform and Bicep on Azure."
---

# GitHub Copilot Prompt — Infrastructure as Code with Terraform

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-09 — DataOps, Platform Engineering & DevOps** - Chapter: **04** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Infrastructure_as_Code.md`.
...
- Begin the file with a single top-level heading: `# Infrastructure as Code with Terraform`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Terraform state, modules, workspaces
- Bicep and ARM comparison
- Provisioning Azure data platforms
- Policy as code and drift
- GitOps for infrastructure

## 4. Prerequisites & Cross-References
Depends on Phase-03/[Azure Landing Zones](../Phase-03/03_Azure_Landing_Zones.prompt.md).
...
- Return ONLY the complete Markdown content for `Infrastructure_as_Code.md`.
