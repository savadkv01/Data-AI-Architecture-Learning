---
mode: agent
description: "Container fundamentals and images for reproducible data workloads."
---

# GitHub Copilot Prompt — Containers with Docker

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-09 — DataOps, Platform Engineering & DevOps** - Chapter: **05** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Containers_Docker.md`.
...
- Begin the file with a single top-level heading: `# Containers with Docker`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Namespaces, cgroups, union filesystems
- Dockerfiles and multi-stage builds
- Image security and registries (ACR)
- Containerizing Spark/Python jobs
- OCI standards

## 4. Prerequisites & Cross-References
Depends on Phase-00/[Operating Systems](../Phase-00/03_Operating_Systems.prompt.md).
...
- Return ONLY the complete Markdown content for `Containers_Docker.md`.
