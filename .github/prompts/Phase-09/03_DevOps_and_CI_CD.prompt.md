---
mode: agent
description: "Pipelines, testing, and release strategies for data and AI systems."
---

# GitHub Copilot Prompt — DevOps and CI/CD

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-09 — DataOps, Platform Engineering & DevOps** - Chapter: **03** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `DevOps_and_CICD.md`.
...
- Begin the file with a single top-level heading: `# DevOps and CI/CD`.
...
- Secrets and artifact management
- Trunk-based development

## 4. Prerequisites & Cross-References
Depends on Phase-09/[DataOps Foundations](01_DataOps_Foundations.prompt.md).
...
- Return ONLY the complete Markdown content for `DevOps_and_CICD.md`.
