---
mode: agent
description: "Internal developer platforms, golden paths, and self-service for data teams."
---

# GitHub Copilot Prompt — Platform Engineering

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-09 — DataOps, Platform Engineering & DevOps** - Chapter: **02** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Platform_Engineering.md`.
...
- Begin the file with a single top-level heading: `# Platform Engineering`.
...
- Return ONLY the complete Markdown content for `Platform_Engineering.md`.
