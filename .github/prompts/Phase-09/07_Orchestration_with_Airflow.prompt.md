---
mode: agent
description: "Authoring, scheduling, and operating pipelines with Airflow."
---

# GitHub Copilot Prompt — Orchestration with Airflow

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-09 — DataOps, Platform Engineering & DevOps** - Chapter: **07** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Orchestration_Airflow.md`.
...
- Begin the file with a single top-level heading: `# Orchestration with Airflow`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- DAGs, operators, sensors, hooks
- Scheduling, backfills, catchup
- Executors and scaling
- Airflow vs ADF vs Dagster vs Prefect
- Managed Airflow on Azure

## 4. Prerequisites & Cross-References
Depends on Phase-05/[Batch Pipeline Design](../Phase-05/09_Batch_Pipeline_Design.prompt.md).
...
- Return ONLY the complete Markdown content for `Orchestration_Airflow.md`.
