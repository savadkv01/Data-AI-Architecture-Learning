---
mode: agent
description: "Applying DevOps and lean principles to data pipelines and platforms."
---

# GitHub Copilot Prompt — DataOps Foundations

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-09 — DataOps, Platform Engineering & DevOps** - Chapter: **01** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `DataOps_Foundations.md`.
...
- Begin the file with a single top-level heading: `# DataOps Foundations`.
...
- Return ONLY the complete Markdown content for `DataOps_Foundations.md`.
