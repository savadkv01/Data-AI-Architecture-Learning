---
mode: agent
description: "Declarative, git-driven delivery and multi-environment strategy."
---

# GitHub Copilot Prompt — GitOps and Environment Management

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-09 — DataOps, Platform Engineering & DevOps** - Chapter: **08** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `GitOps_and_Environments.md`.
...
- Begin the file with a single top-level heading: `# GitOps and Environment Management`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- GitOps principles and Argo CD/Flux
- Environment promotion and config
- Secrets management (Key Vault, SOPS)
- Progressive delivery
- Auditability and rollback

## 4. Prerequisites & Cross-References
Depends on Phase-09/[Infrastructure as Code](04_Infrastructure_as_Code.prompt.md) and [Kubernetes](06_Kubernetes.prompt.md).
...
- Return ONLY the complete Markdown content for `GitOps_and_Environments.md`.
