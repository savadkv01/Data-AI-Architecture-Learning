---
mode: agent
description: "Property graphs, Cypher, and graph modeling for connected data."
---

# GitHub Copilot Prompt — Knowledge Graphs with Neo4j

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-13 — Knowledge Graphs & Vector Systems** - Chapter: **02** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Knowledge_Graphs.md`.
...
- Begin the file with a single top-level heading: `# Knowledge Graphs with Neo4j`.
...
- Graph algorithms (centrality, community)
- Neo4j and Azure Cosmos DB Gremlin

## 4. Prerequisites & Cross-References
Depends on Phase-06/[Data Modeling](../Phase-06/01_Dimensional_Modeling.prompt.md).
...
- Return ONLY the complete Markdown content for `Knowledge_Graphs.md`.
