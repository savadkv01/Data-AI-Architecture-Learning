---
mode: agent
description: "ANN indexing, filtering, and operating vector databases at scale."
---

# GitHub Copilot Prompt — Vector Databases: Qdrant and Milvus

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-13 — Knowledge Graphs & Vector Systems** - Chapter: **01** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Vector_Databases.md`.
...
- Begin the file with a single top-level heading: `# Vector Databases: Qdrant and Milvus`.
...
Depends on Phase-12/[Retrieval Augmented Generation](../Phase-12/03_Retrieval_Augmented_Generation.prompt.md).
...
- Return ONLY the complete Markdown content for `Vector_Databases.md`.
