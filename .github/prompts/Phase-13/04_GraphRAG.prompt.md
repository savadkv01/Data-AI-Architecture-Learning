---
mode: agent
description: "Combining knowledge graphs with retrieval for grounded reasoning."
---

# GitHub Copilot Prompt — GraphRAG

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-13 — Knowledge Graphs & Vector Systems** - Chapter: **04** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `GraphRAG.md`.
...
- Begin the file with a single top-level heading: `# GraphRAG`.
...
Depends on Phase-13/[Knowledge Graphs](02_Knowledge_Graphs.prompt.md) and [Embeddings and Semantic Search](03_Embeddings_and_Semantic_Search.prompt.md).
...
- Return ONLY the complete Markdown content for `GraphRAG.md`.
