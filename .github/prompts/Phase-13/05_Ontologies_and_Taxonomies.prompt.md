---
mode: agent
description: "Formal semantics, ontologies, and the enterprise semantic layer."
---

# GitHub Copilot Prompt — Ontologies and Taxonomies

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-13 — Knowledge Graphs & Vector Systems** - Chapter: **05** - Estimated study time: **45 min + 2h**
...
- Produce **exactly ONE** standalone Markdown file named `Ontologies_and_Taxonomies.md`.
...
- Begin the file with a single top-level heading: `# Ontologies and Taxonomies`.
...
Depends on Phase-13/[Knowledge Graphs](02_Knowledge_Graphs.prompt.md).
...
- Return ONLY the complete Markdown content for `Ontologies_and_Taxonomies.md`.
