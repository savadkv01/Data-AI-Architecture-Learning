---
mode: agent
description: "Managing secrets, keys, and certificates at scale with Key Vault."
---

# GitHub Copilot Prompt — Secrets and Key Management

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-10 — Security, Identity & Compliance** - Chapter: **05** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Secrets_and_Key_Management.md`.
...
- Begin the file with a single top-level heading: `# Secrets and Key Management`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Azure Key Vault and Managed HSM
- Secret rotation and references
- Certificates and mTLS
- HashiCorp Vault comparison
- Secret sprawl and detection

## 4. Prerequisites & Cross-References
Depends on Phase-10/[Data Security and Encryption](03_Data_Security_and_Encryption.prompt.md).
...
- Return ONLY the complete Markdown content for `Secrets_and_Key_Management.md`.
