---
mode: agent
description: "Encryption, tokenization, and data-centric protection."
---

# GitHub Copilot Prompt — Data Security and Encryption

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-10 — Security, Identity & Compliance** - Chapter: **03** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Security_and_Encryption.md`.
...
- Begin the file with a single top-level heading: `# Data Security and Encryption`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Encryption at rest and in transit
- CMK, BYOK, and key rotation
- Tokenization and format-preserving encryption
- Row/column-level security and masking
- Confidential computing

## 4. Prerequisites & Cross-References
Depends on Phase-10/[Identity and Access Management](02_Identity_and_Access_Management.prompt.md).
...
- Return ONLY the complete Markdown content for `Data_Security_and_Encryption.md`.
