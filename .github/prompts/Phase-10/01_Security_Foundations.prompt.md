---
mode: agent
description: "Threat modeling, defense in depth, and the security mindset for data platforms."
---

# GitHub Copilot Prompt — Security Foundations

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-10 — Security, Identity & Compliance** - Chapter: **01** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Security_Foundations.md`.
...
- Begin the file with a single top-level heading: `# Security Foundations`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- CIA triad and threat modeling (STRIDE)
- Defense in depth and least privilege
- OWASP Top 10 for data systems
- Attack surface of data platforms
- Security in the SDLC

## 4. Prerequisites & Cross-References
Depends on Phase-00/[Networking Fundamentals](../Phase-00/04_Networking_Fundamentals.prompt.md).
...
- Return ONLY the complete Markdown content for `Security_Foundations.md`.
