---
mode: agent
description: "Privacy engineering, PII discovery, and anonymization techniques."
---

# GitHub Copilot Prompt — Data Privacy and PII Protection

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-10 — Security, Identity & Compliance** - Chapter: **07** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Privacy_and_PII.md`.
...
- Begin the file with a single top-level heading: `# Data Privacy and PII Protection`.
...
- Right to be forgotten in lakehouses
- Privacy-enhancing technologies

## 4. Prerequisites & Cross-References
Depends on Phase-10/[Compliance and Regulatory](06_Compliance_and_Regulatory.prompt.md).
...
- Return ONLY the complete Markdown content for `Data_Privacy_and_PII.md`.
