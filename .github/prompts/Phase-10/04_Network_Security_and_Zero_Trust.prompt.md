---
mode: agent
description: "Zero-trust networking for data platforms and private connectivity."
---

# GitHub Copilot Prompt — Network Security and Zero Trust

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-10 — Security, Identity & Compliance** - Chapter: **04** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Network_Security_Zero_Trust.md`.
...
- Begin the file with a single top-level heading: `# Network Security and Zero Trust`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Zero-trust principles
- Micro-segmentation and private endpoints
- Egress control and data exfiltration
- Firewalls, WAF, and DDoS
- Securing lakehouse networking

## 4. Prerequisites & Cross-References
Depends on Phase-03/[Azure Networking](../Phase-03/04_Azure_Networking.prompt.md).
...
- Return ONLY the complete Markdown content for `Network_Security_Zero_Trust.md`.
