---
mode: agent
description: "Microsoft Entra ID, RBAC, and workload identity for data platforms."
---

# GitHub Copilot Prompt — Identity and Access Management with Entra

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-10 — Security, Identity & Compliance** - Chapter: **02** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Identity_and_Access_Management.md`.
...
- Begin the file with a single top-level heading: `# Identity and Access Management with Entra`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Entra ID, OAuth2, OIDC, SAML
- RBAC, ABAC, PIM, conditional access
- Managed identities and workload identity
- Service principals and federation
- Access to Storage/Databricks/Synapse

## 4. Prerequisites & Cross-References
Depends on Phase-10/[Security Foundations](01_Security_Foundations.prompt.md).
...
- Return ONLY the complete Markdown content for `Identity_and_Access_Management.md`.
