---
mode: agent
description: "Packaging your work into a compelling architect portfolio."
---

# GitHub Copilot Prompt — Portfolio and Case Studies

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-20 — Capstone & Career** - Chapter: **06** - Estimated study time: **45 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Portfolio_and_Case_Studies.md`.
...
- Begin the file with a single top-level heading: `# Portfolio and Case Studies`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Portfolio structure and narrative
- Writing impactful case studies
- Architecture artifacts to showcase
- Public presence (talks, writing)
- Interview storytelling (STAR)

## 4. Prerequisites & Cross-References
Depends on Phase-20/[Capstone Enterprise Data Platform](01_Capstone_Enterprise_Data_Platform.prompt.md) and [Capstone Enterprise AI Platform](02_Capstone_Enterprise_AI_Platform.prompt.md).
...
- Return ONLY the complete Markdown content for `Portfolio_and_Case_Studies.md`.
