---
mode: agent
description: "A framework and drills for data/AI system design interviews."
---

# GitHub Copilot Prompt — System Design Interview Prep

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-20 — Capstone & Career** - Chapter: **03** - Estimated study time: **60 min + 6h**
...
- Produce **exactly ONE** standalone Markdown file named `System_Design_Interview_Prep.md`.
...
- Begin the file with a single top-level heading: `# System Design Interview Prep`.
...
Depends on Phase-02 through Phase-12.
...
- Return ONLY the complete Markdown content for `System_Design_Interview_Prep.md`.
