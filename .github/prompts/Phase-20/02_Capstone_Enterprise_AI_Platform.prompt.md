---
mode: agent
description: "Design an enterprise AI/LLM/agentic platform on Azure."
---

# GitHub Copilot Prompt — Capstone: Enterprise AI Platform

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-20 — Capstone & Career** - Chapter: **02** - Estimated study time: **90 min + 12h**
...
- Produce **exactly ONE** standalone Markdown file named `Capstone_Enterprise_AI_Platform.md`.
...
- Begin the file with a single top-level heading: `# Capstone: Enterprise AI Platform`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- AI platform reference architecture
- MLOps + LLMOps + agent orchestration
- RAG, vector, and knowledge graph
- Responsible AI and guardrails
- Cost, security, and governance

## 4. Prerequisites & Cross-References
Depends on Phases 11-13 (MLOps, LLMOps, agents, vector/graph).
...
- Return ONLY the complete Markdown content for `Capstone_Enterprise_AI_Platform.md`.
