---
mode: agent
description: "Design a full enterprise lakehouse platform integrating prior phases."
---

# GitHub Copilot Prompt — Capstone: Enterprise Data Platform

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-20 — Capstone & Career** - Chapter: **01** - Estimated study time: **90 min + 12h**
...
- Produce **exactly ONE** standalone Markdown file named `Capstone_Enterprise_Data_Platform.md`.
...
- Begin the file with a single top-level heading: `# Capstone: Enterprise Data Platform`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- End-to-end reference architecture
- Ingestion, lakehouse, serving, governance
- Security, networking, and FinOps
- Operability and reliability
- Full ADR set and diagrams

## 4. Prerequisites & Cross-References
Depends on Phases 03-09 (Azure, lakehouse, streaming, governance, DataOps).
...
- Return ONLY the complete Markdown content for `Capstone_Enterprise_Data_Platform.md`.
