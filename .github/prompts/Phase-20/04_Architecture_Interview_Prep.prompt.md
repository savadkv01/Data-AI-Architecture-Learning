---
mode: agent
description: "Preparing for solution/enterprise architect interviews."
---

# GitHub Copilot Prompt — Architecture Interview Prep

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-20 — Capstone & Career** - Chapter: **04** - Estimated study time: **60 min + 6h**
...
- Produce **exactly ONE** standalone Markdown file named `Architecture_Interview_Prep.md`.
...
- Begin the file with a single top-level heading: `# Architecture Interview Prep`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Architecture case interviews
- Requirements to design under constraints
- Governance and stakeholder scenarios
- Cost and risk reasoning
- Presenting and defending designs

## 4. Prerequisites & Cross-References
Depends on Phase-01 and Phase-19.
...
- Return ONLY the complete Markdown content for `Architecture_Interview_Prep.md`.
