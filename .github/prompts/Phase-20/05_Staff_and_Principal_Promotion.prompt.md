---
mode: agent
description: "Building the scope, impact, and evidence for staff+ promotion."
---

# GitHub Copilot Prompt — Staff and Principal Promotion

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-20 — Capstone & Career** - Chapter: **05** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Staff_Principal_Promotion.md`.
...
- Begin the file with a single top-level heading: `# Staff and Principal Promotion`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Leveling expectations by role
- Demonstrating scope and impact
- Promotion packets and evidence
- Sponsorship and visibility
- Common promotion pitfalls

## 4. Prerequisites & Cross-References
Depends on Phase-19/[Technical Leadership](../Phase-19/01_Technical_Leadership.prompt.md).
...
- Return ONLY the complete Markdown content for `Staff_Principal_Promotion.md`.
