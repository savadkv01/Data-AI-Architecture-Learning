---
mode: agent
description: "Unified governance, cataloging, and data security with Purview."
---

# GitHub Copilot Prompt — Microsoft Purview

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-08 — Data Governance & Quality** - Chapter: **06** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Microsoft_Purview.md`.
...
- Begin the file with a single top-level heading: `# Microsoft Purview`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Data Map, catalog, and scanning
- Classification and sensitivity labels
- Lineage across Azure services
- DLP and access policies
- Purview vs OSS catalogs
...
- Return ONLY the complete Markdown content for `Microsoft_Purview.md`.
