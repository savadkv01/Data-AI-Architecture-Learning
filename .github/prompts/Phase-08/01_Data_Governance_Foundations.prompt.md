---
mode: agent
description: "Operating models, ownership, and policies for enterprise data governance."
---

# GitHub Copilot Prompt — Data Governance Foundations

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-08 — Data Governance & Quality** - Chapter: **01** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Governance_Foundations.md`.
...
- Begin the file with a single top-level heading: `# Data Governance Foundations`.
...
Depends on Phase-01/[Architecture Governance](../Phase-01/02_Architecture_Governance.prompt.md).
...
- Return ONLY the complete Markdown content for `Data_Governance_Foundations.md`.
