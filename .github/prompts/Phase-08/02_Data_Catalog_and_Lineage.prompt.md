---
mode: agent
description: "Discovery, lineage, and impact analysis across the data estate."
---

# GitHub Copilot Prompt — Data Catalog and Lineage

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-08 — Data Governance & Quality** - Chapter: **02** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Catalog_and_Lineage.md`.
...
- Begin the file with a single top-level heading: `# Data Catalog and Lineage`.
...
- Search, tagging, glossaries
- Purview / OpenMetadata / DataHub
...
- Return ONLY the complete Markdown content for `Data_Catalog_and_Lineage.md`.
