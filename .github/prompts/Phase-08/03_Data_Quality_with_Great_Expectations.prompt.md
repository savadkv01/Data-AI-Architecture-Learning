---
mode: agent
description: "Automated data quality testing and monitoring in pipelines."
---

# GitHub Copilot Prompt — Data Quality with Great Expectations

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-08 — Data Governance & Quality** - Chapter: **03** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Quality.md`.
...
- Begin the file with a single top-level heading: `# Data Quality with Great Expectations`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Dimensions of data quality
- Expectations, suites, checkpoints
...
- Return ONLY the complete Markdown content for `Data_Quality.md`.
