---
mode: agent
description: "Golden records, entity resolution, and reference data management."
---

# GitHub Copilot Prompt — Master Data Management

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-08 — Data Governance & Quality** - Chapter: **05** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Master_Data_Management.md`.
...
- Begin the file with a single top-level heading: `# Master Data Management`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- MDM styles: registry, consolidation, coexistence
- Entity resolution and matching
- Golden record survivorship
- Reference data management
- MDM and data mesh tension

## 4. Prerequisites & Cross-References
Depends on Phase-08/[Data Governance Foundations](01_Data_Governance_Foundations.prompt.md).
...
- Return ONLY the complete Markdown content for `Master_Data_Management.md`.
