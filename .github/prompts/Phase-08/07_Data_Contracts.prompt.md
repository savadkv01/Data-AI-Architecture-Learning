---
mode: agent
description: "Schema and SLA contracts that decouple producers and consumers."
---

# GitHub Copilot Prompt — Data Contracts

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-08 — Data Governance & Quality** - Chapter: **07** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Contracts.md`.
...
- Begin the file with a single top-level heading: `# Data Contracts`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Contract anatomy: schema, semantics, SLA
- Producer/consumer responsibilities
- Schema Registry enforcement
- Versioning and breaking changes
- Contracts in data mesh

## 4. Prerequisites & Cross-References
Depends on Phase-08/[Data Quality](03_Data_Quality.prompt.md).
...
- Return ONLY the complete Markdown content for `Data_Contracts.md`.
