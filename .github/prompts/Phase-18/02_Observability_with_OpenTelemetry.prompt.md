---
mode: agent
description: "Traces, metrics, and logs unified through OpenTelemetry."
---

# GitHub Copilot Prompt — Observability with OpenTelemetry

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-18 — FinOps, Observability & Reliability** - Chapter: **02** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Observability_OpenTelemetry.md`.
...
- Begin the file with a single top-level heading: `# Observability with OpenTelemetry`.
...
Depends on Phase-09/[DataOps Foundations](../Phase-09/01_DataOps_Foundations.prompt.md).
...
- Return ONLY the complete Markdown content for `Observability_OpenTelemetry.md`.
