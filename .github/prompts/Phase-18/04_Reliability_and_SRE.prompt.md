---
mode: agent
description: "SLOs, error budgets, and incident management for data platforms."
---

# GitHub Copilot Prompt — Reliability and SRE

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-18 — FinOps, Observability & Reliability** - Chapter: **04** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Reliability_and_SRE.md`.
...
- Begin the file with a single top-level heading: `# Reliability and SRE`.
...
Depends on Phase-02/[Fault Tolerance and Resilience](../Phase-02/07_Fault_Tolerance_and_Resilience.prompt.md).
...
- Return ONLY the complete Markdown content for `Reliability_and_SRE.md`.
