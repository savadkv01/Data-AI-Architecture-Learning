---
mode: agent
description: "Cost visibility, allocation, and optimization for data and AI."
---

# GitHub Copilot Prompt — FinOps and Cost Optimization

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-18 — FinOps, Observability & Reliability** - Chapter: **01** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `FinOps_and_Cost_Optimization.md`.
...
- Begin the file with a single top-level heading: `# FinOps and Cost Optimization`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- FinOps operating model and phases
- Cost allocation, tagging, showback
- Compute/storage optimization levers
- Spot, reservations, and savings plans
- LLM/token cost management

## 4. Prerequisites & Cross-References
Depends on Phase-03/[Well-Architected Framework](../Phase-03/07_Well_Architected_Framework.prompt.md).
...
- Return ONLY the complete Markdown content for `FinOps_and_Cost_Optimization.md`.
