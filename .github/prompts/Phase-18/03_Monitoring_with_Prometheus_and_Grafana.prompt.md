---
mode: agent
description: "Metrics collection, alerting, and dashboards for platforms."
---

# GitHub Copilot Prompt — Monitoring with Prometheus and Grafana

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-18 — FinOps, Observability & Reliability** - Chapter: **03** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Monitoring_Prometheus_Grafana.md`.
...
- Begin the file with a single top-level heading: `# Monitoring with Prometheus and Grafana`.
...
- SLO-based alerting
- Managed Prometheus/Grafana on Azure

## 4. Prerequisites & Cross-References
Depends on Phase-18/[Observability OpenTelemetry](02_Observability_OpenTelemetry.prompt.md).
...
- Return ONLY the complete Markdown content for `Monitoring_Prometheus_Grafana.md`.
