---
mode: agent
description: "Systematic benchmarking and tuning across the data stack."
---

# GitHub Copilot Prompt — Performance Engineering

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-18 — FinOps, Observability & Reliability** - Chapter: **05** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Performance_Engineering.md`.
...
- Begin the file with a single top-level heading: `# Performance Engineering`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Benchmarking methodology
- Profiling and bottleneck analysis
- Query and storage tuning
- Caching and materialization
- Capacity planning

## 4. Prerequisites & Cross-References
Depends on Phase-05/[Apache Spark Internals](../Phase-05/04_Apache_Spark_Internals.prompt.md).
...
- Return ONLY the complete Markdown content for `Performance_Engineering.md`.
