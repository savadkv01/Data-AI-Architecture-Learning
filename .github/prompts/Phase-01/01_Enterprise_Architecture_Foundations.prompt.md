---
mode: agent
description: "TOGAF, Zachman, and the discipline of enterprise architecture for data and AI."
---

# GitHub Copilot Prompt — Enterprise Architecture Foundations

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-01 — Enterprise Architecture Foundations** - Chapter: **01** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Enterprise_Architecture_Foundations.md`.
...
- Begin the file with a single top-level heading: `# Enterprise Architecture Foundations`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- TOGAF ADM, Zachman, and architecture domains
- Business, data, application, and technology architecture
- Reference architectures and capability maps
- Architecture principles and standards
- Where a data/AI architect sits in the org

## 4. Prerequisites & Cross-References
Depends on Phase-00/[Distributed Systems Primer](../Phase-00/08_Distributed_Systems_Primer.prompt.md).
...
- Return ONLY the complete Markdown content for `Enterprise_Architecture_Foundations.md`.
