---
mode: agent
description: "Writing durable, reviewable ADRs that scale across large engineering organizations."
---

# GitHub Copilot Prompt — Architecture Decision Records

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-01 — Enterprise Architecture Foundations** - Chapter: **03** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Architecture_Decision_Records.md`.
...
- Begin the file with a single top-level heading: `# Architecture Decision Records`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- ADR anatomy: context, decision, consequences, alternatives
- Lightweight vs heavyweight decision records
- Decision logs and traceability
- Reversible (Type 2) vs irreversible (Type 1) decisions
- Templates and tooling (MADR, Log4brains)

## 4. Prerequisites & Cross-References
Depends on Phase-01/[Architecture Governance](02_Architecture_Governance.prompt.md).
...
- Return ONLY the complete Markdown content for `Architecture_Decision_Records.md`.
