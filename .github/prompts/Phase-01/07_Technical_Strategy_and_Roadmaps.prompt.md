---
mode: agent
description: "Crafting multi-year technical strategy and executable roadmaps for data and AI."
---

# GitHub Copilot Prompt — Technical Strategy and Roadmaps

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-01 — Enterprise Architecture Foundations** - Chapter: **07** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Technical_Strategy_and_Roadmaps.md`.
...
- Begin the file with a single top-level heading: `# Technical Strategy and Roadmaps`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Vision, strategy, and North Star metrics
- Build vs buy vs partner decisions
- Sequencing, dependencies, and bets
- Communicating strategy to executives
- Balancing innovation and reliability

## 4. Prerequisites & Cross-References
Depends on Phase-01/[Business Capability Modeling](06_Business_Capability_Modeling.prompt.md).
...
- Return ONLY the complete Markdown content for `Technical_Strategy_and_Roadmaps.md`.
