---
mode: agent
description: "Bounded contexts, ubiquitous language, and strategic design for data platforms."
---

# GitHub Copilot Prompt — Domain Driven Design

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-01 — Enterprise Architecture Foundations** - Chapter: **05** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Domain_Driven_Design.md`.
...
- Begin the file with a single top-level heading: `# Domain Driven Design`.
...
- Ubiquitous language and event storming
- DDD as the backbone of Data Mesh domains

## 4. Prerequisites & Cross-References
Depends on Phase-01/[Solution Architecture Practice](04_Solution_Architecture_Practice.prompt.md).
...
- Return ONLY the complete Markdown content for `Domain_Driven_Design.md`.
