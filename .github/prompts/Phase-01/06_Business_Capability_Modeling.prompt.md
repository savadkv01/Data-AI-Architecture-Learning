---
mode: agent
description: "Mapping business capabilities to data products, platforms, and investment."
---

# GitHub Copilot Prompt — Business Capability Modeling

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-01 — Enterprise Architecture Foundations** - Chapter: **06** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Business_Capability_Modeling.md`.
...
- Begin the file with a single top-level heading: `# Business Capability Modeling`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Capability maps and heat maps
- Value streams and business motivation models
- Linking capabilities to data domains
- Investment and portfolio prioritization
...
- Return ONLY the complete Markdown content for `Business_Capability_Modeling.md`.
