---
mode: agent
description: "From requirements to a defensible solution design under real-world constraints."
---

# GitHub Copilot Prompt — Solution Architecture Practice

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-01 — Enterprise Architecture Foundations** - Chapter: **04** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Solution_Architecture_Practice.md`.
...
- Begin the file with a single top-level heading: `# Solution Architecture Practice`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Requirements, constraints, and quality attributes
- Trade-off analysis (ATAM-style)
- C4 model and views/viewpoints
- Non-functional requirements as first-class citizens
- Producing HLD and LLD artifacts
...
- Return ONLY the complete Markdown content for `Solution_Architecture_Practice.md`.
