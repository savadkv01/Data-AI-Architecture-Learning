---
mode: agent
description: "Establishing and running architecture review boards, standards, and guardrails."
---

# GitHub Copilot Prompt — Architecture Governance

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-01 — Enterprise Architecture Foundations** - Chapter: **02** - Estimated study time: **45 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Architecture_Governance.md`.
...
- Begin the file with a single top-level heading: `# Architecture Governance`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Architecture Review Boards and RFC processes
- Tech radar, golden paths, paved roads
- Standards, exceptions, and technical debt registers
- Guardrails vs gates; policy as code
- Measuring architecture health

## 4. Prerequisites & Cross-References
Depends on Phase-01/[Enterprise Architecture Foundations](01_Enterprise_Architecture_Foundations.prompt.md).
...
- Return ONLY the complete Markdown content for `Architecture_Governance.md`.
