---
mode: agent
description: "Stateful stream processing, checkpointing, and exactly-once with Flink."
---

# GitHub Copilot Prompt — Apache Flink

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-07 — Streaming & Real-Time Analytics** - Chapter: **04** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Apache_Flink.md`.
...
- Begin the file with a single top-level heading: `# Apache Flink`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Dataflow model and operators
- Managed state and state backends
- Checkpointing and savepoints
- Exactly-once and two-phase commit sinks
...
- Return ONLY the complete Markdown content for `Apache_Flink.md`.
