---
mode: agent
description: "Streaming database changes reliably with CDC patterns."
---

# GitHub Copilot Prompt — Change Data Capture

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-07 — Streaming & Real-Time Analytics** - Chapter: **06** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Change_Data_Capture.md`.
...
- Begin the file with a single top-level heading: `# Change Data Capture`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Log-based vs query-based CDC
- Debezium and connectors
- Ordering, dedup, and tombstones
- CDC into Delta/Iceberg
- Azure SQL/Cosmos change feed
...
- Return ONLY the complete Markdown content for `Change_Data_Capture.md`.
