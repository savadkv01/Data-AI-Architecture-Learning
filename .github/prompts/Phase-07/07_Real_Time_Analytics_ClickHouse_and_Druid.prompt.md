---
mode: agent
description: "Sub-second analytical queries over high-velocity data."
---

# GitHub Copilot Prompt — Real-Time Analytics: ClickHouse and Druid

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-07 — Streaming & Real-Time Analytics** - Chapter: **07** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Real_Time_Analytics.md`.
...
- Begin the file with a single top-level heading: `# Real-Time Analytics: ClickHouse and Druid`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- OLAP for streaming: ClickHouse, Druid, Pinot
- Ingestion and indexing
- Materialized views and rollups
- Azure Data Explorer (Kusto)
- Real-time dashboards and serving

## 4. Prerequisites & Cross-References
Depends on Phase-07/[Streaming Fundamentals](01_Streaming_Fundamentals.prompt.md).
...
- Return ONLY the complete Markdown content for `Real_Time_Analytics.md`.
