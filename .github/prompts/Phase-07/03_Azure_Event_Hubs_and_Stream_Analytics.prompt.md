---
mode: agent
description: "Managed streaming ingestion and processing on Azure."
---

# GitHub Copilot Prompt — Azure Event Hubs and Stream Analytics

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-07 — Streaming & Real-Time Analytics** - Chapter: **03** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Azure_Event_Hubs_and_Stream_Analytics.md`.
...
- Begin the file with a single top-level heading: `# Azure Event Hubs and Stream Analytics`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Event Hubs partitions and throughput units
- Kafka protocol compatibility
- Stream Analytics jobs and queries
- Capture to ADLS and integration
- Event Hubs vs Kafka on Azure

## 4. Prerequisites & Cross-References
Depends on Phase-07/[Apache Kafka](02_Apache_Kafka.prompt.md).
...
- Return ONLY the complete Markdown content for `Azure_Event_Hubs_and_Stream_Analytics.md`.
