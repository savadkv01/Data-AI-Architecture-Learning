---
mode: agent
description: "Event-time, windows, watermarks, and delivery semantics."
---

# GitHub Copilot Prompt — Streaming Fundamentals

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-07 — Streaming & Real-Time Analytics** - Chapter: **01** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Streaming_Fundamentals.md`.
...
- Begin the file with a single top-level heading: `# Streaming Fundamentals`.
...
Depends on Phase-02/[Time, Clocks and Ordering](../Phase-02/06_Time_Clocks_and_Ordering.prompt.md).
...
- Return ONLY the complete Markdown content for `Streaming_Fundamentals.md`.
