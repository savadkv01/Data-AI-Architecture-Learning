---
mode: agent
description: "Kafka internals: partitions, replication, consumer groups, and exactly-once."
---

# GitHub Copilot Prompt — Apache Kafka

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-07 — Streaming & Real-Time Analytics** - Chapter: **02** - Estimated study time: **90 min + 6h**
...
- Produce **exactly ONE** standalone Markdown file named `Apache_Kafka.md`.
...
- Begin the file with a single top-level heading: `# Apache Kafka`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Topics, partitions, offsets
- Replication, ISR, and leader election
- Producers, consumer groups, rebalancing
- Exactly-once and transactions
- Kafka Connect and Schema Registry

## 4. Prerequisites & Cross-References
Depends on Phase-07/[Streaming Fundamentals](01_Streaming_Fundamentals.prompt.md) and Phase-02/[Replication and Consistency](../Phase-02/02_Replication_and_Consistency.prompt.md).
...
- Return ONLY the complete Markdown content for `Apache_Kafka.md`.
