---
mode: agent
description: "Micro-batch and continuous streaming on the lakehouse."
---

# GitHub Copilot Prompt — Spark Structured Streaming

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-07 — Streaming & Real-Time Analytics** - Chapter: **05** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Spark_Structured_Streaming.md`.
...
- Begin the file with a single top-level heading: `# Spark Structured Streaming`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Micro-batch execution model
- Stateful ops and watermarks
- Checkpointing to Delta
- Streaming joins and dedup
- Trigger modes and latency tuning

## 4. Prerequisites & Cross-References
Depends on Phase-05/[Apache Spark Internals](../Phase-05/04_Apache_Spark_Internals.prompt.md) and Phase-07/[Streaming Fundamentals](01_Streaming_Fundamentals.prompt.md).
...
- Return ONLY the complete Markdown content for `Spark_Structured_Streaming.md`.
