---
mode: agent
description: "The four principles of data mesh and their organizational implications."
---

# GitHub Copilot Prompt — Data Mesh Principles

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-15 — Data Mesh & Data Fabric** - Chapter: **01** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Mesh_Principles.md`.
...
- Begin the file with a single top-level heading: `# Data Mesh Principles`.
...
Depends on Phase-01/[Domain Driven Design](../Phase-01/05_Domain_Driven_Design.prompt.md) and Phase-08/[Data Governance Foundations](../Phase-08/01_Data_Governance_Foundations.prompt.md).
...
- Return ONLY the complete Markdown content for `Data_Mesh_Principles.md`.
