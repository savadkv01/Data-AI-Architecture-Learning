---
mode: agent
description: "Global policies with local autonomy through computational governance."
---

# GitHub Copilot Prompt — Federated Governance

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-15 — Data Mesh & Data Fabric** - Chapter: **04** - Estimated study time: **45 min + 2h**
...
- Produce **exactly ONE** standalone Markdown file named `Federated_Governance.md`.
...
- Begin the file with a single top-level heading: `# Federated Governance`.
...
- Governance guild and roles
- Balancing autonomy and control

## 4. Prerequisites & Cross-References
Depends on Phase-15/[Data Mesh Principles](01_Data_Mesh_Principles.prompt.md).
...
- Return ONLY the complete Markdown content for `Federated_Governance.md`.
