---
mode: agent
description: "Platform capabilities that enable autonomous domain teams."
---

# GitHub Copilot Prompt — Self-Serve Data Platform

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-15 — Data Mesh & Data Fabric** - Chapter: **05** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Self_Serve_Data_Platform.md`.
...
- Begin the file with a single top-level heading: `# Self-Serve Data Platform`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Platform capability planes
- Provisioning and templates
- Golden paths for data products
- Observability and cost transparency
- Mesh on Azure/Databricks/Fabric

## 4. Prerequisites & Cross-References
Depends on Phase-09/[Platform Engineering](../Phase-09/02_Platform_Engineering.prompt.md) and Phase-15/[Data Products](02_Data_Products.prompt.md).
...
- Return ONLY the complete Markdown content for `Self_Serve_Data_Platform.md`.
