---
mode: agent
description: "Designing, packaging, and operating data as first-class products."
---

# GitHub Copilot Prompt — Data Products

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-15 — Data Mesh & Data Fabric** - Chapter: **02** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Products.md`.
...
- Begin the file with a single top-level heading: `# Data Products`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Data product anatomy and ports
...
- Return ONLY the complete Markdown content for `Data_Products.md`.
