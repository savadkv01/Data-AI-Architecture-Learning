---
mode: agent
description: "Metadata-driven integration and the data fabric approach."
---

# GitHub Copilot Prompt — Data Fabric

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-15 — Data Mesh & Data Fabric** - Chapter: **03** - Estimated study time: **45 min + 2h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Fabric.md`.
...
- Begin the file with a single top-level heading: `# Data Fabric`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Data fabric vs data mesh
- Active metadata and knowledge graph
- Automated integration and virtualization
- Data virtualization engines
- Fabric on Azure

## 4. Prerequisites & Cross-References
Depends on Phase-08/[Metadata Management](../Phase-08/04_Metadata_Management.prompt.md).
...
- Return ONLY the complete Markdown content for `Data_Fabric.md`.
