---
mode: agent
description: "Urban-scale sensor, mobility, and services data platforms."
---

# GitHub Copilot Prompt — Smart Cities

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-17 — Industry Vertical Platforms** - Chapter: **04** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Smart_Cities.md`.
...
- Begin the file with a single top-level heading: `# Smart Cities`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Mobility and traffic data
- Urban digital twins
- Citizen privacy and ethics
- Open data and interoperability
- Sustainability analytics

## 4. Prerequisites & Cross-References
Depends on Phase-16/[IoT Data Platforms](../Phase-16/01_IoT_Data_Platforms.prompt.md) and Phase-16/[Digital Twins](../Phase-16/07_Digital_Twins.prompt.md).
...
- Return ONLY the complete Markdown content for `Smart_Cities.md`.
