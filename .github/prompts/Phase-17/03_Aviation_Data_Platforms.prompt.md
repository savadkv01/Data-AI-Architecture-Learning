---
mode: agent
description: "Flight, sensor, and operational data at airline and OEM scale."
---

# GitHub Copilot Prompt — Aviation Data Platforms

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-17 — Industry Vertical Platforms** - Chapter: **03** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Aviation_Data_Platforms.md`.
...
- Begin the file with a single top-level heading: `# Aviation Data Platforms`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Flight and engine telemetry
- Predictive maintenance (prognostics)
- Operations and network optimization
- Safety-critical data standards
- Data sovereignty across regions

## 4. Prerequisites & Cross-References
Depends on Phase-16/[IoT Data Platforms](../Phase-16/01_IoT_Data_Platforms.prompt.md).
...
- Return ONLY the complete Markdown content for `Aviation_Data_Platforms.md`.
