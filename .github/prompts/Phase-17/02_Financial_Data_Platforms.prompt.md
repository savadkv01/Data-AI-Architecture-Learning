---
mode: agent
description: "Low-latency, auditable, regulated financial data systems."
---

# GitHub Copilot Prompt — Financial Data Platforms

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-17 — Industry Vertical Platforms** - Chapter: **02** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Financial_Data_Platforms.md`.
...
- Begin the file with a single top-level heading: `# Financial Data Platforms`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Market data and tick pipelines
- Risk, fraud, and AML analytics
- Auditability and lineage
- Regulatory reporting (BCBS 239)
- Low-latency and accuracy trade-offs

## 4. Prerequisites & Cross-References
Depends on Phase-10/[Compliance and Regulatory](../Phase-10/06_Compliance_and_Regulatory.prompt.md).
...
- Return ONLY the complete Markdown content for `Financial_Data_Platforms.md`.
