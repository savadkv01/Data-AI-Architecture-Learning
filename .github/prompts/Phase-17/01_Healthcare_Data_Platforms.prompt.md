---
mode: agent
description: "FHIR, HIPAA, and interoperable healthcare data architecture."
---

# GitHub Copilot Prompt — Healthcare Data Platforms

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-17 — Industry Vertical Platforms** - Chapter: **01** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Healthcare_Data_Platforms.md`.
...
- Begin the file with a single top-level heading: `# Healthcare Data Platforms`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- FHIR and HL7 standards
- Azure Health Data Services
- PHI protection and HIPAA
- Clinical and genomics pipelines
...
- Return ONLY the complete Markdown content for `Healthcare_Data_Platforms.md`.
