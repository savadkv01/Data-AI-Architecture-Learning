---
mode: agent
description: "Personalization, inventory, and real-time commerce analytics."
---

# GitHub Copilot Prompt — Retail and E-Commerce Data

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-17 — Industry Vertical Platforms** - Chapter: **05** - Estimated study time: **60 min + 3h**
...
- Produce **exactly ONE** standalone Markdown file named `Retail_and_Ecommerce_Data.md`.
...
- Begin the file with a single top-level heading: `# Retail and E-Commerce Data`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Clickstream and event pipelines
- Recommendation systems
- Real-time inventory and pricing
- Customer 360 and CDP
- Peak-scale (Black Friday) design

## 4. Prerequisites & Cross-References
Depends on Phase-07/[Real-Time Analytics](../Phase-07/07_Real_Time_Analytics.prompt.md) and Phase-11/[ML Pipeline Architecture](../Phase-11/06_ML_Pipeline_Architecture.prompt.md).
...
- Return ONLY the complete Markdown content for `Retail_and_Ecommerce_Data.md`.
