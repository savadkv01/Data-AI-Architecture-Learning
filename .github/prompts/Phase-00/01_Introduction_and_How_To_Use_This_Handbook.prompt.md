---
mode: agent
description: "Orientation, learning path, and how to work through the Enterprise Data & AI Architecture Handbook."
---

# GitHub Copilot Prompt — Introduction and How To Use This Handbook

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-00 — Foundations & Prerequisites** - Chapter: **01** - Estimated study time: **30 minutes**
...
- Produce **exactly ONE** standalone Markdown file named `Introduction.md`.
...
- Begin the file with a single top-level heading: `# Introduction and How To Use This Handbook`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- The target career ladder: Senior -> Lead -> Staff -> Principal -> Data/Solution/Enterprise Architect -> Head of Data/AI -> CDO/CAIO
- How the phases, dependency graph, and roadmap fit together
- How to use each chapter: theory, labs, case studies, interview drills
- Study cadence for a one-year intensive plan
- How to self-assess readiness for each role level
...
- Return ONLY the complete Markdown content for `Introduction.md`.
