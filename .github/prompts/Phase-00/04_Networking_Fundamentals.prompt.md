---
mode: agent
description: "TCP/IP, DNS, TLS, load balancing, and their effect on distributed data systems."
---

# GitHub Copilot Prompt — Networking Fundamentals

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-00 — Foundations & Prerequisites** - Chapter: **04** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Networking_Fundamentals.md`.
...
- Begin the file with a single top-level heading: `# Networking Fundamentals`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- OSI/TCP-IP model, packets, MTU, latency vs bandwidth
- DNS, HTTP/1.1 vs HTTP/2 vs HTTP/3, gRPC transport
- TLS handshake, certificates, mTLS
- Load balancing (L4/L7), proxies, service discovery
- Network partitions and their role in distributed failures

## 4. Prerequisites & Cross-References
Depends on Phase-00/[Operating Systems](03_Operating_Systems.prompt.md).
...
- Return ONLY the complete Markdown content for `Networking_Fundamentals.md`.
