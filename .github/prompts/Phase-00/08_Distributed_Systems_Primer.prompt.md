---
mode: agent
description: "The vocabulary and mental models for reasoning about distributed data platforms."
---

# GitHub Copilot Prompt — Distributed Systems Primer

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-00 — Foundations & Prerequisites** - Chapter: **08** - Estimated study time: **60 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Distributed_Systems_Primer.md`.
...
- Begin the file with a single top-level heading: `# Distributed Systems Primer`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Why distribution: scale, availability, geo-locality
- Failure models: crash, omission, Byzantine
- Latency, throughput, tail latency, SLIs/SLOs
- Idempotency, retries, at-least/at-most/exactly-once
- Introduction to consistency and consensus

## 4. Prerequisites & Cross-References
Depends on Phase-00/[Networking Fundamentals](04_Networking_Fundamentals.prompt.md) and [Concurrency and Parallelism](06_Concurrency_and_Parallelism.prompt.md).
...
- Return ONLY the complete Markdown content for `Distributed_Systems_Primer.md`.
