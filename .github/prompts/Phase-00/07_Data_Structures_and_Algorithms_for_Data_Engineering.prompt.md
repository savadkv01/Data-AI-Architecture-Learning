---
mode: agent
description: "Probabilistic and disk-oriented data structures that power modern data systems."
---

# GitHub Copilot Prompt — Data Structures and Algorithms for Data Engineering

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-00 — Foundations & Prerequisites** - Chapter: **07** - Estimated study time: **60 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `Data_Structures_and_Algorithms.md`.
...
- Begin the file with a single top-level heading: `# Data Structures and Algorithms for Data Engineering`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Hash tables, sorting, external merge sort
- Bloom filters, HyperLogLog, Count-Min sketch
- B+ trees, LSM-trees, skip lists
- Roaring bitmaps, tries, inverted indexes
...
- Return ONLY the complete Markdown content for `Data_Structures_and_Algorithms.md`.
