---
mode: agent
description: "Core CS foundations an architect must reason about: complexity, memory, encoding, and computation models."
---

# GitHub Copilot Prompt — Computer Science Fundamentals

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-00 — Foundations & Prerequisites** - Chapter: **02** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Computer_Science_Fundamentals.md`.
...
- Begin the file with a single top-level heading: `# Computer Science Fundamentals`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Time/space complexity and its impact on data-system cost
- Memory hierarchy, cache lines, locality of reference
- Binary/text encodings, UTF-8, endianness, serialization
- Computation models: batch, streaming, MapReduce, dataflow
- Numerical precision, floating point, and data-quality implications

## 4. Prerequisites & Cross-References
Read [Introduction](01_Introduction.prompt.md) first.
...
- Return ONLY the complete Markdown content for `Computer_Science_Fundamentals.md`.
