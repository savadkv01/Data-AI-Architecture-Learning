---
mode: agent
description: "How OS internals (scheduling, memory, I/O, filesystems) shape data-platform performance."
---

# GitHub Copilot Prompt — Operating Systems for Data Engineers

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-00 — Foundations & Prerequisites** - Chapter: **03** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Operating_Systems.md`.
...
- Begin the file with a single top-level heading: `# Operating Systems for Data Engineers`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Processes, threads, context switching, and CPU scheduling
- Virtual memory, paging, page cache, huge pages
- Filesystems, block vs object I/O, buffered vs direct I/O
- Linux tooling for data workloads (cgroups, ulimits, NUMA)
- How OS behavior surfaces as Spark/Kafka performance issues

## 4. Prerequisites & Cross-References
Depends on Phase-00/[Computer Science Fundamentals](02_Computer_Science_Fundamentals.prompt.md).
...
- Return ONLY the complete Markdown content for `Operating_Systems.md`.
