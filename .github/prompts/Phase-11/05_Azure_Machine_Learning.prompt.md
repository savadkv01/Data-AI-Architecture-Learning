---
mode: agent
description: "End-to-end ML on Azure ML: pipelines, endpoints, and governance."
---

# GitHub Copilot Prompt — Azure Machine Learning

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-11 — AI Platform Engineering & MLOps** - Chapter: **05** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Azure_Machine_Learning.md`.
...
- Begin the file with a single top-level heading: `# Azure Machine Learning`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Workspaces, compute, and datastores
- Azure ML pipelines and components
- Managed online/batch endpoints
- Model registry and MLflow integration
- Responsible AI dashboard

## 4. Prerequisites & Cross-References
Depends on Phase-11/[MLOps and MLflow](03_MLOps_and_MLflow.prompt.md).
...
- Return ONLY the complete Markdown content for `Azure_Machine_Learning.md`.
