---
mode: agent
description: "Fairness, explainability, safety, and governance of AI systems."
---

# GitHub Copilot Prompt — Responsible AI

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-11 — AI Platform Engineering & MLOps** - Chapter: **07** - Estimated study time: **45 min + 2h**
...
- Produce **exactly ONE** standalone Markdown file named `Responsible_AI.md`.
...
- Begin the file with a single top-level heading: `# Responsible AI`.
...
- AI risk and regulation (EU AI Act)
- Microsoft Responsible AI Standard

## 4. Prerequisites & Cross-References
Depends on Phase-11/[Azure Machine Learning](05_Azure_Machine_Learning.prompt.md).
...
- Return ONLY the complete Markdown content for `Responsible_AI.md`.
