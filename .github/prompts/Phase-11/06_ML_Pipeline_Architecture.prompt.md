---
mode: agent
description: "Designing production ML pipelines from data to deployment and monitoring."
---

# GitHub Copilot Prompt — ML Pipeline Architecture

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-11 — AI Platform Engineering & MLOps** - Chapter: **06** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `ML_Pipeline_Architecture.md`.
...
- Begin the file with a single top-level heading: `# ML Pipeline Architecture`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Data -> feature -> train -> deploy -> monitor
...
Depends on Phase-11/[Feature Stores](02_Feature_Stores.prompt.md) and [MLOps and MLflow](03_MLOps_and_MLflow.prompt.md).
...
- Return ONLY the complete Markdown content for `ML_Pipeline_Architecture.md`.
