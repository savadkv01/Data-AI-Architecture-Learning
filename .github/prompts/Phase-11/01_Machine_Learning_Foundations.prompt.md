---
mode: agent
description: "The ML lifecycle and concepts an AI platform architect must master."
---

# GitHub Copilot Prompt — Machine Learning Foundations

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-11 — AI Platform Engineering & MLOps** - Chapter: **01** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Machine_Learning_Foundations.md`.
...
- Begin the file with a single top-level heading: `# Machine Learning Foundations`.

## 3. Chapter Scope
Cover the following concretely and in depth:
- Supervised/unsupervised/RL basics
...
Depends on Phase-00/[Data Structures and Algorithms](../Phase-00/07_Data_Structures_and_Algorithms.prompt.md).
...
- Return ONLY the complete Markdown content for `Machine_Learning_Foundations.md`.
