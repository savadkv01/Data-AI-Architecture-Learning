---
mode: agent
description: "Experiment tracking, model registry, and reproducible ML delivery."
---

# GitHub Copilot Prompt — MLOps and MLflow

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-11 — AI Platform Engineering & MLOps** - Chapter: **03** - Estimated study time: **75 min + 5h**
...
- Produce **exactly ONE** standalone Markdown file named `MLOps_and_MLflow.md`.
...
- Begin the file with a single top-level heading: `# MLOps and MLflow`.
...
Depends on Phase-09/[DevOps and CICD](../Phase-09/03_DevOps_and_CICD.prompt.md) and Phase-11/[Machine Learning Foundations](01_Machine_Learning_Foundations.prompt.md).
...
- Return ONLY the complete Markdown content for `MLOps_and_MLflow.md`.
