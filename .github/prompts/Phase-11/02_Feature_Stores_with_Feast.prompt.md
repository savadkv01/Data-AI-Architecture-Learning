---
mode: agent
description: "Consistent online/offline features and preventing training-serving skew."
---

# GitHub Copilot Prompt — Feature Stores with Feast

> Part of the **Enterprise Data & AI Architecture Handbook**.
> Phase: **Phase-11 — AI Platform Engineering & MLOps** - Chapter: **02** - Estimated study time: **60 min + 4h**
...
- Produce **exactly ONE** standalone Markdown file named `Feature_Stores.md`.
...
- Begin the file with a single top-level heading: `# Feature Stores with Feast`.
...
- Feature governance and reuse

## 4. Prerequisites & Cross-References
Depends on Phase-11/[Machine Learning Foundations](01_Machine_Learning_Foundations.prompt.md).
...
- Return ONLY the complete Markdown content for `Feature_Stores.md`.
